...
import{m_ as we,jl as ie,aC as ne,eA as De,_ as se,ep as c,fs as I,eC as ae,v as g,eW as N,eq as R,fy as F,fV as re,eD as P,fB as b,aD as le,ft as Ee,fw as oe,aE as Ve,fE as G,y as S,z as xe,aJ as X,L as Le,f$ as ye,fA as k}from"./index-BfC8i6jT.js";import{l as Ce,v as W,p as $,b as Se}from"./lineSegment-DbTVMGoh.js";import{t as Ae}from"./VisualElement-C8pAhQko.js";import{a as Me,y as Re,m as $e,j as Te,p as Oe}from"./frustum-Bdr-rFEQ.js";import{V as qe,_ as Ie,l as ze}from"./sphere-BgvJtIjV.js";import{K as je,J as We,L as Ne}from"./RenderGeometry-BYg-7xwk.js";import{t as He}from"./DoubleArray-CZhUFo5d.js";import{t as Ue}from"./glUtil-C6KhMg1m.js";import{H as Be}from"./InterleavedLayout-D5nIvpjN.js";import{L as Fe,M as Ge,u as z,o as ce,q as y,i as he,r as de,j as pe,K as Xe,b as A,E as J}from"./Texture-1xthaLvE.js";import{e as p}from"./VertexAttribute-BnAa5VW0.js";import{R as T,E as ke,F as Je}from"./enums-BlUEVwJR.js";import{S as ue,s as fe,_ as ge}from"./renderState-yUi34s5A.js";import{c as Ke}from"./BufferObject-CLFFt1Oe.js";import{r as E,t as Qe}from"./ShaderTechniqueConfiguration-D3UbJ2mX.js";import{o as r,n as Ye}from"./interfaces-B8ge7Jg9.js";import{O as Ze,i as et}from"./Material-CL7oq3ds.js";import"./BindType-BmZEZMMh.js";import{c as d,h as m,i as K}from"./Matrix4PassUniform-BH4JqvtO.js";import{E as tt,j as it}from"./plane-ByuX_NXR.js";function _e(e,t){const n=e.fragment;n.include(Fe),e.include(Ge),n.uniforms.add(new d("globalAlpha",i=>i.globalAlpha),new m("glowColor",i=>i.glowColor),new d("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new d("glowFalloff",i=>i.glowFalloff),new m("innerColor",i=>i.innerColor),new d("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new z("depthMap",(i,s)=>{var a;return(a=s.depth)==null?void 0:a.attachment}),new z("normalMap",i=>i.normals),new z("frameColor",(i,s)=>s.mainColor)),n.code.add(r`vec4 blendPremultiplied(vec4 source, vec4 dest) {
...
}`)}function me(e){const t=new ce;t.include(_e,e);const{vertex:n,fragment:i}=t;return n.uniforms.add(new K("modelView",(s,{camera:a})=>we(st,a.viewMatrix,s.origin)),new K("proj",(s,{camera:a})=>a.projectionMatrix),new d("glowWidth",(s,{camera:a})=>s.glowWidth*a.pixelRatio),new y("pixelToNDC",(s,{camera:a})=>ie(nt,2/a.fullViewport[2],2/a.fullViewport[3]))),t.attributes.add(p.START,"vec3"),t.attributes.add(p.END,"vec3"),t.attributes.add(p.UP,"vec3"),t.attributes.add(p.EXTRUDE,"vec2"),t.varyings.add("uv","vec2"),t.varyings.add("vViewStart","vec3"),t.varyings.add("vViewEnd","vec3"),t.varyings.add("vViewPlane","vec4"),n.code.add(r`void main() {
...
}`),t}const nt=ne(),st=De(),at=Object.freeze(Object.defineProperty({__proto__:null,build:me},Symbol.toStringTag,{value:"Module"}));class O extends de{initializeProgram(t){return new pe(t.rctx,O.shader.get().build(this.configuration),Pe)}initializePipeline(){return ue({blending:fe(T.ONE,T.ONE_MINUS_SRC_ALPHA),colorWrite:ge})}}O.shader=new he(at,()=>se(()=>Promise.resolve().then(()=>mt),void 0));const Pe=new Map([[p.START,0],[p.END,1],[p.UP,2],[p.EXTRUDE,3]]);class Q{constructor(t){this._renderCoordsHelper=t,this._buffers=null,this._origin=c(),this._dirty=!1,this._count=0,this._vao=null}set vertices(t){const n=He(3*t.length);let i=0;for(const s of t)n[i++]=s[0],n[i++]=s[1],n[i++]=s[2];this.buffers=[n]}set buffers(t){if(this._buffers=t,this._buffers.length>0){const n=this._buffers[0],i=3*Math.floor(n.length/3/2);I(this._origin,n[i],n[i+1],n[i+2])}else I(this._origin,0,0,0);this._dirty=!0}get origin(){return this._origin}draw(t){const n=this._ensureVAO(t);n!=null&&(t.bindVAO(n),t.drawArrays(ke.TRIANGLES,0,this._count))}dispose(){this._vao!=null&&this._vao.dispose()}_ensureVAO(t){return this._buffers==null?null:(this._vao==null&&(this._vao=this._createVAO(t,this._buffers)),this._ensureVertexData(this._vao,this._buffers),this._vao)}_createVAO(t,n){const i=this._createDataBuffer(n);return this._dirty=!1,new je(t,Pe,{data:Ue(ee)},{data:Ke.createVertex(t,Je.STATIC_DRAW,i)})}_ensureVertexData(t,n){var s;if(!this._dirty)return;const i=this._createDataBuffer(n);(s=t.vertexBuffers.data)==null||s.setData(i),this._dirty=!1}_createDataBuffer(t){const n=t.reduce((_,u)=>_+Y(u),0);this._count=n;const i=ee.createBuffer(n),s=this._origin;let a=0,l=0;for(const _ of t){for(let u=0;u<_.length;u+=3){const C=I(Z,_[u],_[u+1],_[u+2]);u===0?l=this._renderCoordsHelper.getAltitude(C):this._renderCoordsHelper.setAltitude(C,l);const D=this._renderCoordsHelper.worldUpAtPosition(C,rt),o=a+2*u,B=ae(Z,C,s);if(u<_.length-3){i.up.setVec(o,D),i.up.setVec(o+3,D),i.up.setVec(o+5,D);for(let v=0;v<6;v++)i.start.setVec(o+v,B);i.extrude.setValues(o,0,-1),i.extrude.setValues(o+1,1,-1),i.extrude.setValues(o+2,1,1),i.extrude.setValues(o+3,0,-1),i.extrude.setValues(o+4,1,1),i.extrude.setValues(o+5,0,1)}if(u>0){i.up.setVec(o-2,D),i.up.setVec(o-4,D),i.up.setVec(o-5,D);for(let v=-6;v<0;v++)i.end.setVec(o+v,B)}}a+=Y(_)}return i.buffer}}function Y(e){return 3*(2*(e.length/3-1))}const rt=c(),Z=c(),ee=Be().vec3f(p.START).vec3f(p.END).vec3f(p.UP).vec2f(p.EXTRUDE);class H extends Qe{constructor(){super(...arguments),this.contrastControlEnabled=!1}}g([E()],H.prototype,"contrastControlEnabled",void 0);const U=N(6);function be(e){const t=new ce;t.include(Xe),t.include(_e,e);const n=t.fragment;if(e.lineVerticalPlaneEnabled||e.heightManifoldEnabled)if(n.uniforms.add(new d("maxPixelDistance",(i,s)=>e.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
float dist = dot(plane.xyz, pos) + plane.w;
float width = fwidth(dist);
dist /= min(width, maxPixelDistance);
return abs(dist);
}`),e.spherical){const i=(a,l,_)=>P(a,l.heightManifoldTarget,_.camera.viewMatrix),s=(a,l)=>P(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new A("heightManifoldOrigin",(a,l)=>(i(f,a,l),s(V,l),ae(V,V,f),R(h,V),h[3]=F(V),h)),new m("globalOrigin",(a,l)=>s(f,l)),new d("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,re(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/F(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
...
}`)),e.intersectsLineEnabled&&(n.uniforms.add(new y("angleCutoff",i=>M(i)),new m("intersectsLineStart",(i,s)=>P(f,i.lineStartWorld,s.camera.viewMatrix)),new m("intersectsLineEnd",(i,s)=>P(f,i.lineEndWorld,s.camera.viewMatrix)),new m("intersectsLineDirection",(i,s)=>(b(h,i.intersectsLineSegment.vector),h[3]=0,R(f,le(h,h,s.camera.viewMatrix)))),new d("intersectsLineRadius",i=>i.intersectsLineRadius)),n.code.add(r`{
