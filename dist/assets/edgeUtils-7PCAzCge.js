import{cs as M,R as T,fF as m,lg as h,a1 as I,eg as x}from"./index-BfC8i6jT.js";import{o as g}from"./floatRGBA-BcMV1NFr.js";import{a as S}from"./DecodeSymbolColor.glsl-BR7HIChu.js";import{a as E,b as w,s as F,o as O,t as y,c as L,d as u,e as P,f as b,g as v,h as p,i as V}from"./Matrix4PassUniform-BH4JqvtO.js";import{o as N}from"./Float4DrawUniform-DSpHBPg2.js";import{a as $}from"./BindType-BmZEZMMh.js";import{o as n}from"./interfaces-B8ge7Jg9.js";import{e as s}from"./VertexAttribute-BnAa5VW0.js";function R(o){return o.type==="fill"}function W(o){return o.type==="extrude"}var i;(function(o){o[o.INVISIBLE=0]="INVISIBLE",o[o.TRANSPARENT=1]="TRANSPARENT",o[o.OPAQUE=2]="OPAQUE"})(i||(i={}));class A extends E{constructor(r,e){super(r,"int",$.Draw,(t,a,l)=>t.setUniform1i(r,e(a,l)))}}var c;(function(o){o[o.Uniform=0]="Uniform",o[o.Varying=1]="Varying",o[o.COUNT=2]="COUNT"})(c||(c={}));const f=429496.7296;function oo(o,r){g(o/f*.5+.5,r)}function eo(o,r){switch(r.componentData){case c.Varying:return z(o,r);case c.Uniform:return U(o,r);case c.COUNT:return;default:M(r.componentData)}}function z(o,r){const{vertex:e,fragment:t}=o;e.include(w),e.uniforms.add(new F("componentColorTex",l=>l.componentParameters.texture.texture)),o.attributes.add(s.COMPONENTINDEX,"float"),o.varyings.add("vExternalColorMixMode","mediump float"),o.varyings.add("vExternalColor","vec4");const a=r.output===O.ObjectAndLayerIdColor;a&&o.varyings.add("vObjectAndLayerIdColor","vec4"),o.include(S),e.constants.add("elevationScale","float",2*f),e.constants.add("stride","float",T("enable-feature:objectAndLayerId-rendering")?3:2),e.code.add(n`vec2 getComponentTextureCoordinates(float componentIndex, float typeOffset) {
...
`)}function U(o,r){const{vertex:e,fragment:t}=o;e.uniforms.add(new N("externalColor",l=>l.componentParameters.externalColor)),t.uniforms.add(new A("externalColorMixMode",l=>l.componentParameters.externalColorMixMode)),o.varyings.add("vExternalColor","vec4"),e.code.add(n`float readElevationOffset() {
return 0.0;
}
void forwardObjectAndLayerIdColor() {}
vec4 forwardExternalColor(out bool castShadows) {
