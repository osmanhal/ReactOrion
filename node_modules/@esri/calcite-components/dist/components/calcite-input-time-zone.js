...
import { d as defineCustomElement$6 } from './combobox.js';
import { d as defineCustomElement$5 } from './combobox-item.js';
import { d as defineCustomElement$4 } from './combobox-item-group.js';
...
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
    if (mode === "name") {
        const { groupByName } = await import('./index2.js');
...
//# sourceMappingURL=calcite-input-time-zone.js.map