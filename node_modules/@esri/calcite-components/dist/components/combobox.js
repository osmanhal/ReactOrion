...
import { C as getElementWidth, D as getTextWidth, t as toAriaBoolean } from './dom.js';
import { b as defaultMenuPlacement, f as filterValidFlipPlacements, c as connectFloatingUI, r as reposition, a as disconnectFloatingUI, F as FloatingCSS } from './floating-ui.js';
...
const XButton = ({ disabled, key, label, onClick, ref, scale, }) => (h("button", { "aria-label": label, class: CSS.button, disabled: disabled, key: key, onClick: onClick, ref: ref, tabIndex: -1, type: "button" },
