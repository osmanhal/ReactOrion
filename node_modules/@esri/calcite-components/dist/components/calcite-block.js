...
import { d as slotChangeHasAssignedElement, f as focusFirstTabbable, g as getSlotted, t as toAriaBoolean } from './dom.js';
...
const Block = /*@__PURE__*/ proxyCustomElement(class Block extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: 'b5c12059b36785bf45ce61e7309a35278b928088' }, h(InteractiveContainer, { key: '90a5013ca2e30dadbd76c146700a53391f3aea62', disabled: this.disabled }, h("article", { key: '825f15336afb992c7ea8c718b5ffad7c4bf2507e', "aria-busy": toAriaBoolean(loading), class: {
                [CSS.container]: true,
            } }, headerNode, h("section", { key: '4f690563d78615b68a225456aaae593af6adb826', "aria-labelledby": IDS.toggle, class: CSS.content, hidden: !open, id: IDS.content }, this.renderScrim())))));
    }
...
//# sourceMappingURL=calcite-block.js.map