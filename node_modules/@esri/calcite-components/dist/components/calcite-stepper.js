 ...
 * v2.12.1
 */
import { h, proxyCustomElement, HTMLElement, createEvent, Host, readTask } from '@stencil/core/internal/client';
import { s as slotChangeGetAssignedElements, v as focusElementInGroup } from './dom.js';
...
const Stepper = /*@__PURE__*/ proxyCustomElement(class Stepper extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: 'bd7571b5c3af662f4a2bde52e9742e2328fc7c8f', "aria-label": this.messages.label, role: "region" }, h("div", { key: '9e1d066b9f3ec7fa1df9f55e6e742d0c26cd4ec2', class: { container: true, [CSS$1.singleView]: this.layout === "horizontal-single" }, ref: this.setContainerEl }, this.layout === "horizontal-single" && (h("div", { key: '49ccb52be5e2c1c747cbe634d3049fc5677ac7c2', class: { [CSS$1.stepBarContainer]: true } }, this.items.map((item, index) => (h(StepBar, { active: index === this.currentActivePosition, complete: item.complete && index !== this.currentActivePosition && !item.error, disabled: item.disabled && index !== this.currentActivePosition, error: item.error && index !== this.currentActivePosition, key: index }))))), this.layout === "horizontal-single" && (h("div", { key: 'd771370bda9cfc17412208ea9de36c52f9c9fabd', class: { [CSS$1.actionContainer]: true } }, this.renderAction("start"), this.renderAction("end"))), h("slot", { key: '8c9f00eda6193622c72943bc459b8e3adf69fe77', onSlotchange: this.handleDefaultSlotChange }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
    ...
    static get style() { return CalciteStepperStyle0; }
        ...
        "startStep": [64],
        "endStep": [64]
    }, [[0, "calciteInternalStepperItemKeyEvent", "calciteInternalStepperItemKeyEvent"], [0, "calciteInternalStepperItemRegister", "registerItem"], [0, "calciteInternalStepperItemSelect", "updateItem"], [0, "calciteStepperItemSelect", "handleItemSelect"]], {
        "icon": ["handleItemPropChange"],
        "layout": ["handleItemPropChange"],
        "numbered": ["handleItemPropChange"],
        "scale": ["handleItemPropChange"],
...
//# sourceMappingURL=calcite-stepper.js.map