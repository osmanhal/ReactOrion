 ...
 */
export declare const componentsWithInputEvent: string[];
/**
 ...
 */
export declare function getClearValidationEventName(componentTag: string): string;
 ...
 * @param component
 */
export declare function findAssociatedForm(component: FormOwner): HTMLFormElement | null;
/**
...
export declare const internalHiddenInputInputEvent = "calciteInternalHiddenInputInput";
