...
export declare class Combobox implements LabelableComponent, FormComponent, InteractiveComponent, OpenCloseComponent, FloatingUIComponent, T9nComponent, LoadableComponent {
     ...
     */
    readOnly: boolean;
    documentClickHandler(event: PointerEvent): Promise<void>;
    calciteComboboxItemChangeHandler(event: CustomEvent<HTMLCalciteComboboxItemElement>): void;
    calciteInternalComboboxItemChangeHandler(event: CustomEvent<HTMLCalciteComboboxItemElement>): void;
    /**
    ...
    private allSelectedIndicatorChipEl;
    private filterTextMatchPattern;
    ...
    compactSelectionDisplay: boolean;
    selectedHiddenChipsCount: number;
    selectedVisibleChipsCount: number;
    ...
    private floatingEl;
    private referenceEl;
    private chipContainerEl;
    private listContainerEl;
    private ignoreSelectedEventsFlag;
    private maxCompactBreakpoint;
    openTransitionProp: string;
    private selectedIndicatorChipEl;
    ...
    private setVisibleAndHiddenChips;
    private getMaxScrollerHeight;
    private calculateScrollerHeight;
