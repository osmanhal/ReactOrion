        ...
        return {
            ...
            "detachedHeightScale": {
                ...
                "docs": {
                    ...
                    "text": "When `displayMode` is `float-content` or `float`, specifies the maximum height of the component."
                },
            ...
            "resizable": {
                ...
                "docs": {
                    "tags": [],
                    "text": "When `true` and `displayMode` is not `float-content` or `float`, the component's content area is resizable."
                },
                "attribute": "resizable",
                "reflect": true,
                "defaultValue": "false"
