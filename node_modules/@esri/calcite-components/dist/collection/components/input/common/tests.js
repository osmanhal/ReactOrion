...
export function testPostValidationFocusing(inputTag) {
...
export function testHiddenInputSyncing(inputTag) {
    ...
    `);
        ...
        await page.waitForChanges();
        async function assertTextProps() {
        ...
        async function assertNumericProps() {
...
export function testWorkaroundForGlobalPropRemoval(inputTag) {
