...
export class List {
    ...
    static get properties() {
        return {
            ...
            "filterProps": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Specifies the properties to match against when filtering. If not set, all properties will be matched (label, description, metadata, value)."
                }
            },
            "messageOverrides": {
                "type": "unknown",
    ...
    static get watchers() {
        return [{
                ...
                "methodName": "handlefilterPropsChange"
            }, {
