...
:host([scale=s]) {
  ...
  --calcite-internal-loader-value-line-height: 0.625rem;
}
...
:host([scale=m]) {
  ...
  --calcite-internal-loader-value-line-height: 1.375rem;
}
...
:host([scale=l]) {
  ...
  --calcite-internal-loader-value-line-height: 1.71875rem;
}
...
:host([type=determinate-value]) .loader__svgs{
  animation: none;
}
:host([type=determinate]) .loader__svg--3,
:host([type=determinate-value]) .loader__svg--3{
  animation: none;
  stroke: var(--calcite-color-brand);
