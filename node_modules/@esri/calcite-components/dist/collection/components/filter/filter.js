    ...
    static get properties() {
        return {
            ...
            "filterProps": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Specifies the properties to match against when filtering. This will only apply when `value` is an object. If not set, all properties will be matched."
                }
            },
            "placeholder": {
                "type": "string",
