...
export function filterValidFlipPlacements(placements, el) {
 ...
 * @internal
 */
export const autoUpdatingComponentMap = new WeakMap();
 ...
 */
export async function connectFloatingUI(component, referenceEl, floatingEl) {
