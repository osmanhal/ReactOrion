 ...
 */
export function filterElementsBySelector(elements, selector) {
 ...
 * @returns {Element[]} An array of elements.
 */
export function slotChangeGetAssignedElements(event, selector) {
 ...
 * @returns {Element[]} An array of elements.
 */
export function getSlotAssignedElements(slot, selector) {
 ...
 * @returns {boolean} The value.
 */
export function isKeyboardTriggeredClick(event) {
 ...
 */
export async function whenAnimationDone(targetEl, animationName, onStart, onEnd) {
 ...
 */
export async function whenTransitionDone(targetEl, transitionProp, onStart, onEnd) {
 ...
 */
export async function whenTransitionOrAnimationDone(targetEl, transitionPropOrAnimationName, type, onStart, onEnd) {
