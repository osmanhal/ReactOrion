 ...
 * v2.12.1
 */
import { r as registerInstance, c as createEvent, h, g as getElement, F as Fragment, H as Host } from './index-590f87c2.js';
import { c as createObserver } from './observers-aea7721f.js';
import { d as focusElement, t as toAriaBoolean } from './dom-0dfcce02.js';
...
const Option = class {
    ...
    //--------------------------------------------------------------------------
    render() {
        return h("slot", { key: '19660c07dc760b742b61169da73469d1579aeeaa' }, this.label);
    }
...
const Select = class {
    ...
    render() {
        const { disabled } = this;
        return (h(Host, { key: '70938120b9aaac3ab07b8bd73ca8e7909c2ea11d' }, h(InteractiveContainer, { key: 'bd7b8839b27ff53f51d1a4fc2e3590b9fb8ab913', disabled: disabled }, h("div", { key: '3dbf7d32dc39c929f7f939e1e1cc72ca6d0b386f', class: CSS.wrapper }, h("select", { key: 'e6763a83fed5e7162d94d93e82e770dbbd238bd7', "aria-errormessage": IDS.validationMessage, "aria-invalid": toAriaBoolean(this.status === "invalid"), "aria-label": getLabelText(this), class: CSS.select, disabled: disabled, onChange: this.handleInternalSelectChange, ref: this.storeSelectRef }, h("slot", { key: '68fc9d08be9144e1f874602ecdf46f3cc0eceb05' })), this.renderChevron(), h(HiddenFormInputSlot, { key: '6d5ec3ed6f6d2551679a7e17c9023f32b67b4a2c', component: this })), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "value": ["valueHandler"],
