...
import { d as focusElement, e as getSlotted, t as toAriaBoolean } from './dom-0dfcce02.js';
import { d as debounce } from './debounce-87018c17.js';
import { h, H as Host } from './index-590f87c2.js';
import { I as InteractiveContainer } from './interactive-7dc921d0.js';
...
const List = ({ props: { disabled, loading, filterEnabled, dataForFilter, handleFilterEvent, filterPlaceholder, filterText, setFilterEl, dragEnabled, storeAssistiveEl, }, ...rest }) => {
    ...
    return (h(Host, { "aria-busy": toAriaBoolean(loading), role: "menu", ...rest },
        h(InteractiveContainer, { disabled: disabled },
            h("section", null,
                dragEnabled ? (h("span", { "aria-live": "assertive", class: "assistive-text", ref: storeAssistiveEl })) : null,
                h("header", { class: { [CSS$1.sticky]: true } },
                    filterEnabled ? (h("calcite-filter", { "aria-label": filterPlaceholder, disabled: disabled, items: dataForFilter, onCalciteFilterChange: handleFilterEvent, placeholder: filterPlaceholder, ref: setFilterEl, value: filterText })) : null,
...
//# sourceMappingURL=resources-a9e811d8.js.map