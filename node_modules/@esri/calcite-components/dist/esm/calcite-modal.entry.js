...
import { e as getSlotted, b as slotChangeHasAssignedElement, f as focusFirstTabbable, x as ensureId } from './dom-0dfcce02.js';
import { d as deactivateFocusTrap, a as activateFocusTrap, c as connectFocusTrap, u as updateFocusTrapElements } from './focusTrapComponent-4c78325e.js';
...
import { l as logger } from './logger-8f7eea99.js';
...
const Modal = class {
    ...
    render() {
        return (h(Host, { key: 'd40092ac4db27ed1c0e6daca0c14fd04ddb31d9a', "aria-describedby": this.contentId, "aria-labelledby": this.titleId, "aria-modal": "true", role: "dialog" }, h("div", { key: '4c83a7e297d6fffe5c2474470d5978f82845d6cd', class: {
                [CSS.container]: true,
                [CSS.containerOpen]: this.opened,
                [CSS.containerEmbedded]: this.embedded,
            } }, h("calcite-scrim", { key: 'a44f73d132b0b98006f537830d4f4f9aa7d511cd', class: CSS.scrim, onClick: this.handleOutsideClose }), this.renderStyle(), h("div", { key: '3c08fd60cb8f90ba69a1293a4525fbd1c0262a02', class: {
                [CSS.modal]: true,
            }, ref: this.setTransitionEl }, h("div", { key: '11e69d8bbc52b3cb58eccebb73729fa344b5e734', class: CSS.header }, this.renderCloseButton(), h("header", { key: '30a4fb2e0cc53ce639fb40ec1b7956b262a5884c', class: CSS.title }, h("slot", { key: '3782f2b397e46f3dd8e0d4253b1071b1d98ffb65', name: CSS.header }))), this.renderContentTop(), h("div", { key: '271a0f1f18e0e20614425005ec905201db0ec6db', class: {
                [CSS.content]: true,
                [CSS.contentNoFooter]: !this.hasFooter,
            }, ref: (el) => (this.modalContent = el) }, h("slot", { key: 'e5e55e5af91ab8d3971cb74c005656d9beb06e2f', name: SLOTS.content })), this.renderContentBottom(), this.renderFooter()))));
    }
    renderFooter() {
