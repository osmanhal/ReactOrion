 ...
 * v2.12.1
 */
import { r as registerInstance, c as createEvent, h, g as getElement, F as Fragment } from './index-590f87c2.js';
import { C as CSSColorMode, n as normalizeHex, a as hexify, b as Color, o as opacityToAlpha, c as CSS$2, d as alphaToOpacity, D as DEFAULT_COLOR$1, e as DIMENSIONS, f as alphaCompatible, g as getSliderWidth, p as parseMode, j as normalizeColor, k as colorEqual, R as RGB_LIMITS, H as HSV_LIMITS, O as OPACITY_LIMITS, t as toNonAlphaMode, l as normalizeAlpha, m as HUE_LIMIT_CONSTRAINED, S as SCOPE_SIZE, q as DEFAULT_STORAGE_KEY_PREFIX, r as toAlphaMode, s as isLonghandHex, u as isShorthandHex, i as isValidHex, v as rgbToHex, w as hexChar } from './utils-aae8a221.js';
import { u as isPrimaryPointerButton, g as getElementDir, f as focusFirstTabbable, d as focusElement, i as getModeName } from './dom-0dfcce02.js';
...
import { r as remap, c as clamp, a as closeToRangeEdge } from './math-db618c8a.js';
import { u as updateMessages, s as setUpMessages, c as connectMessages, d as disconnectMessages } from './t9n-249fa143.js';
import { t as throttle } from './throttle-3c598a1c.js';
...
const ColorPicker = class {
    ...
    render() {
        ...
        return (h(InteractiveContainer, { key: 'cd7c2469429382b1adee89c87c4774160795203c', disabled: this.disabled }, h("div", { key: 'dd6809c82d3ffe64b8eaebd0669e7f61c0ea87d1', class: CSS$2.container }, h("div", { key: '888c08c46fec112861b076c3cf24b9be7b4a66cd', class: CSS$2.controlAndScope }, h("canvas", { key: '23631c824c61abb2a3ca74e35bffc8be0364a052', class: CSS$2.colorField, onPointerDown: this.handleColorFieldPointerDown, ref: this.initColorField }), h("div", { key: 'a5271bbe3c4f45e3cf7736dd8f4201f54420bfb7', "aria-label": vertical ? messages.value : messages.saturation, "aria-valuemax": vertical ? HSV_LIMITS.v : HSV_LIMITS.s, "aria-valuemin": "0", "aria-valuenow": (vertical ? color?.saturationv() : color?.value()) || "0", class: { [CSS$2.scope]: true, [CSS$2.colorFieldScope]: true }, onKeyDown: this.handleColorFieldScopeKeyDown, ref: this.storeColorFieldScope, role: "slider", style: {
                top: `${adjustedColorFieldScopeTop || 0}px`,
                left: `${adjustedColorFieldScopeLeft || 0}px`,
            }, tabindex: "0" })), h("div", { key: 'eee6c10107513fd46316d2ba7510977b72771cd2', class: CSS$2.previewAndSliders }, h("calcite-color-picker-swatch", { key: '964481e1c6c6c050df076e8cdc9d7e5b2cbeec79', class: CSS$2.preview, color: selectedColorInHex, scale: this.alphaChannel ? "l" : this.scale }), h("div", { key: 'f915032fe532e140005b0ff1253b0a971a17b079', class: CSS$2.sliders }, h("div", { key: '2bcb609ce36df2d0f75abb767ee6dc88c0c9ea3b', class: CSS$2.controlAndScope }, h("canvas", { key: '99e268a194b785a8ec97fed67a523c602def2a94', class: { [CSS$2.slider]: true, [CSS$2.hueSlider]: true }, onPointerDown: this.handleHueSliderPointerDown, ref: this.initHueSlider }), h("div", { key: '4cdc0f98048a48e070430bf4f1f817571534f31b', "aria-label": messages.hue, "aria-valuemax": HSV_LIMITS.h, "aria-valuemin": "0", "aria-valuenow": color?.round().hue() || DEFAULT_COLOR$1.round().hue(), class: { [CSS$2.scope]: true, [CSS$2.hueScope]: true }, onKeyDown: this.handleHueScopeKeyDown, ref: this.storeHueScope, role: "slider", style: {
