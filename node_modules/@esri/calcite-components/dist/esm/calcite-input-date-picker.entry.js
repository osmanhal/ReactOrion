...
import { d as datePartsFromISO, a as datePartsFromLocalizedString, b as dateFromLocalizedString, i as inRange, c as dateToISO, g as getValueAsDateRange, e as dateFromISO, f as dateFromRange, h as getLocaleData } from './utils-9489087b.js';
import { f as focusFirstTabbable, t as toAriaBoolean } from './dom-0dfcce02.js';
import { f as filterValidFlipPlacements, c as connectFloatingUI, d as defaultMenuPlacement, r as reposition, a as disconnectFloatingUI, F as FloatingCSS } from './floating-ui-ce3cc5e5.js';
...
import { c as connectLabel, d as disconnectLabel } from './label-3e643a13.js';
import { c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-907717a5.js';
import { n as numberStringFormatter, c as connectLocalized, d as disconnectLocalized, b as getDateFormatSupportedLocale, e as getSupportedNumberingSystem } from './locale-4ce3c6b2.js';
...
import { c as connectFocusTrap, d as deactivateFocusTrap, a as activateFocusTrap } from './focusTrapComponent-4c78325e.js';
...
import './debounce-87018c17.js';
import './observers-aea7721f.js';
...
const InputDatePicker = class {
    ...
    render() {
        ...
        return (h(Host, { key: '38f3ea7b3206b0b5d404c6691d54811ce9e09753', onBlur: this.blurHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: '64296d7cf55e492e041eee729d969733f0aeeede', disabled: this.disabled }, this.localeData && (h("div", { key: 'bb1244e8a1ac6e32bc71f08a98d8007b17a3332d', class: CSS.inputContainer }, h("div", { key: 'fcb3e2430616bae57d9e09ea1f631bdb6c9810f0', class: CSS.inputWrapper, "data-position": "start", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown, ref: this.setStartWrapper }, h("calcite-input-text", { key: '4c1e9dea4f553f206251bafefd05993b5c897b41', "aria-autocomplete": "none", "aria-controls": this.dialogId, "aria-describedby": this.placeholderTextId, "aria-errormessage": IDS.validationMessage, "aria-expanded": toAriaBoolean(this.open), "aria-haspopup": "dialog", "aria-invalid": toAriaBoolean(this.status === "invalid"), class: {
                [CSS.input]: true,
            ...
            this.renderToggleIcon(this.open && this.focusedInput === "start"), h("span", { key: '705abe452a2f49cc167f1051ca193b397d6cef9f', "aria-hidden": "true", class: CSS.assistiveText, id: this.placeholderTextId }, "Date Format: ", this.localeData?.placeholder)), h("div", { key: 'bf71124065fdfefa0a6024e245aee31eee3a5b5e', "aria-hidden": toAriaBoolean(!this.open), "aria-label": messages.chooseDate, "aria-live": "polite", "aria-modal": "true", class: {
                [CSS.menu]: true,
