 ...
 * v2.12.1
 */
import { h, r as registerInstance, c as createEvent, H as Host, g as getElement } from './index-590f87c2.js';
import { c as calciteSize48 } from './core-cf110972.js';
import { f as filter, e as escapeRegExp } from './filter-7bf2ff32.js';
import { C as nodeListToArray, E as getElementWidth, F as getTextWidth, t as toAriaBoolean, e as getSlotted } from './dom-0dfcce02.js';
import { d as defaultMenuPlacement, f as filterValidFlipPlacements, c as connectFloatingUI, r as reposition, a as disconnectFloatingUI, F as FloatingCSS } from './floating-ui-ce3cc5e5.js';
import { s as submitForm, c as connectForm, a as afterConnectDefaultValueSet, d as disconnectForm, H as HiddenFormInputSlot } from './form-0d9970ac.js';
...
import { b as componentLoaded, c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-907717a5.js';
import { c as connectLocalized, d as disconnectLocalized } from './locale-4ce3c6b2.js';
import { c as createObserver } from './observers-aea7721f.js';
import { o as onToggleOpenCloseComponent } from './openCloseComponent-55f53a59.js';
import { D as DEBOUNCE } from './resources-988e2a52.js';
import { c as connectMessages, s as setUpMessages, d as disconnectMessages, u as updateMessages } from './t9n-249fa143.js';
import { g as getIconScale, c as componentOnReady } from './component-3035aa13.js';
...
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-7bdf6b11.js';
import './key-6b945008.js';

const CSS$3 = {
    button: "x-button",
};
const XButton = ({ disabled, key, label, onClick, ref, scale, }) => (h("button", { "aria-label": label, class: CSS$3.button, disabled: disabled, key: key, onClick: onClick, ref: ref, tabIndex: -1, type: "button" },
...
const Combobox = class {
    ...
    render() {
        ...
        return (h(Host, { key: '24749edfdb12a51e6e34c78d3428f83de7ac0457', onClick: this.comboboxFocusHandler }, h(InteractiveContainer, { key: '7300de366d86bcad91501f1124aed5f311820c37', disabled: this.disabled }, h("div", { key: 'fc8981935ffdd46fc5386517fce51170d41179a5', "aria-live": "polite", class: {
                wrapper: true,
        ...
        ], h("label", { key: '60ca38b6b84d8ccd3e11419ca494c8a3b310e631', class: "screen-readers-only", htmlFor: `${inputUidPrefix}${guid}`, id: `${labelUidPrefix}${guid}` }, label), this.renderInput()), !readOnly && isClearable ? (h(XButton, { disabled: this.disabled, key: "close-button", label: this.messages.clear, scale: this.scale })) : null, !readOnly && this.renderChevronIcon()), h("ul", { key: 'bb750b55b33af3a317ac7883d4f8ef88a23bf1c6', "aria-labelledby": `${labelUidPrefix}${guid}`, "aria-multiselectable": "true", class: "screen-readers-only", id: `${listboxUidPrefix}${guid}`, role: "listbox", tabIndex: -1 }, this.renderListBoxOptions()), this.renderFloatingUIContainer(), h(HiddenFormInputSlot, { key: 'bf9a9f0dc62822568377ee1e602e24ca14b9c895', component: this }), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
...
const ComboboxItem = class {
    ...
    render() {
        ...
        return (h(Host, { key: '893a354b69619332b4f45458224aa8b41f90111e', "aria-hidden": "true", "aria-label": itemLabel }, h(InteractiveContainer, { key: 'd476f526f4d55a6b7b2cf498f97eb2a8db67222b', disabled: disabled }, h("div", { key: '327153394df9ebd4e6cd5dbd409d7fdd473beb3e', class: {
                [CSS$1.container]: true,
                [CSS$1.scale(this.scale)]: true,
            }, style: { "--calcite-combobox-item-spacing-indent-multiplier": `${depth}` } }, h("li", { key: 'f9a623aafce0135cb4e7e9e30579f98e18bf38e6', class: classes, id: this.guid, onClick: this.itemClickHandler }, this.renderSelectIndicator(showDot, iconPath), this.renderIcon(iconPath), h("div", { key: '8d90ab670e01f935a4217e24e175cc9e6cebfecf', class: CSS$1.centerContent }, h("div", { key: '176cc0659c8778c2f77be2f3912963b121e99ee7', class: CSS$1.title }, this.renderTextContent(headingText)), this.description ? (h("div", { class: CSS$1.description }, this.renderTextContent(this.description))) : null), this.shortHeading ? (h("div", { class: CSS$1.shortText }, this.renderTextContent(this.shortHeading))) : null, h("slot", { key: '8646cb9cde757ea2e34ec0c3f8cdc6ac806e1142', name: SLOTS.contentEnd })), this.renderChildren()))));
    }
