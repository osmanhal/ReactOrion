 ...
 * v2.12.1
 */
import { r as registerInstance, c as createEvent, h, F as Fragment, H as Host, g as getElement } from './index-590f87c2.js';
...
const CalciteNavigationLogo = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'b76572e79734c7190d373225662f453423450d9a' }, h("a", { key: '77d1604fd344f2d5aea65842067a615343aa591b', class: CSS$1.anchor, href: this.href, rel: this.rel, target: this.target }, thumbnail && h("img", { key: 'abf6396d63acf26f5ad5e2bb5c9dd280c3728134', alt: this.label || "", class: CSS$1.image, src: thumbnail }), this.icon && this.renderIcon(), this.renderHeaderContent())));
    }
...
const CalciteNavigationUser = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (h(Host, { key: '71dafc89185ed082fa48f68f10620f680703edf7' }, h("button", { key: 'e175503f28873b42aa231f29077449da12696072', "aria-label": this.label, class: CSS.button }, h("calcite-avatar", { key: 'de83763dcb0811cd7abfdb32003e69fbaf580b6f', "full-name": this.fullName, label: this.label, thumbnail: this.thumbnail, "user-id": this.userId, username: this.username }), (this.fullName || this.username) && !this.textDisabled && (h("div", { key: 'a54fd497c59ef3ad171b2f35394a27f5dd060d64', class: CSS.textContainer }, this.fullName && (h("span", { class: CSS.fullName, key: CSS.fullName }, this.fullName)), this.username && (h("span", { class: CSS.username, key: CSS.username }, this.username)))))));
    }
    static get delegatesFocus() { return true; }
    get el() { return getElement(this); }
};
