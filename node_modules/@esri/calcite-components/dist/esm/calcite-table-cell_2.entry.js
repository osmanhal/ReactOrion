 ...
 * v2.12.1
 */
import { r as registerInstance, h, H as Host, g as getElement } from './index-590f87c2.js';
...
import { g as getElementDir } from './dom-0dfcce02.js';
...
const TableHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '55805e40fd5617971301fe6c3df52fd45ff4486e' }, h("th", { key: '2f7c756603386e578a871558645daac673fd6cdc', "aria-colindex": this.parentRowType === "head" ? this.positionInRow : undefined, class: {
            ...
            }, colSpan: this.colSpan, onBlur: this.onContainerBlur, onFocus: this.onContainerFocus, ref: (el) => (this.containerEl = el), role: this.parentRowType === "head" ? "columnheader" : "rowheader", rowSpan: this.rowSpan, scope: scope, tabIndex: this.selectionCell ? 0 : staticCell ? -1 : 0 }, this.heading && h("div", { key: 'e347778a1676cf40c5f4c2937a590ac8b6c1fde0', class: CSS.heading }, this.heading), this.description && h("div", { key: '13c5d2ec28bf68132c1217be299aa4363794f370', class: CSS.description }, this.description), this.selectionCell && this.selectionMode === "multiple" && (h("calcite-icon", { key: '11f84e3c1c3cb8be33c8c5aa4a2cc4f5d01fbbfa', class: { [CSS.active]: indeterminate || checked }, icon: selectionIcon, scale: getIconScale(this.scale) })), (this.selectionCell || this.numberCell) && (h("span", { key: '23c2914de335aa02bf99b1d9286ad2b2ad38cccb', "aria-hidden": true, "aria-live": this.focused ? "polite" : "off", class: CSS.assistiveText }, this.screenReaderText)))));
    }
    static get assetsDirs() { return ["assets"]; }
    get el() { return getElement(this); }
    static get watchers() { return {
