...
import { c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-0d9970ac.js';
...
import { f as focusFirstTabbable } from './dom-0dfcce02.js';
...
const StarIcon = ({ full, scale, partial }) => (h("calcite-icon", { class: partial ? undefined : "icon",
...
const Rating = class {
    ...
    render() {
        return (h(Host, { key: '9c08ab0a8eee6854a1d88fd2ed538e1a95ce5d62', onKeyDown: this.handleHostKeyDown, onPointerOut: this.handleRatingPointerOut, onPointerOver: this.handleRatingPointerOver }, h(InteractiveContainer, { key: 'fc3a022e1943f0e52eaba60423ac44eb58011326', disabled: this.disabled }, h("span", { key: '89dba59e95b9bdc552d5557df7e7df32b71ac4e4', class: "wrapper" }, h("fieldset", { key: '69a2c7a774dc7a19c15fd2e9b36f4da8f088b1ef', class: "fieldset", disabled: this.disabled }, h("legend", { key: '9266db4c44647a70b367581bff35c67e0a5ba3be', class: "visually-hidden" }, this.messages.rating), this.starsMap.map(({ average, checked, fraction, hovered, id, partial, selected, value, tabIndex, }) => {
        ...
        }), (this.count || this.average) && this.showChip ? (h("calcite-chip", { scale: this.scale, value: this.count?.toString() }, !!this.average && h("span", { class: "number--average" }, this.average.toString()), !!this.count && h("span", { class: "number--count" }, "(", this.count?.toString(), ")"))) : null), h(HiddenFormInputSlot, { key: '80020e22ccaacc218647bf50d7a3aa6fbfadf5fb', component: this })))));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
