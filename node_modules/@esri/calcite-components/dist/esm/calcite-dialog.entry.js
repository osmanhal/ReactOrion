...
import { t as toAriaBoolean, f as focusFirstTabbable } from './dom-0dfcce02.js';
import { c as connectFocusTrap, d as deactivateFocusTrap, u as updateFocusTrapElements, a as activateFocusTrap } from './focusTrapComponent-4c78325e.js';
...
import { s as setUpMessages, c as connectMessages, d as disconnectMessages, u as updateMessages } from './t9n-249fa143.js';
import { c as componentOnReady } from './component-3035aa13.js';
import { S as SLOTS$1 } from './resources-480def39.js';
import './guid-c5ea645c.js';
import './resources-988e2a52.js';
import './config-df1b58be.js';
...
const Dialog = class {
    ...
    render() {
        ...
        return (h(Host, { key: '6a00a9f9c7c9ba8079b24cae446322bfa258348d' }, h("div", { key: 'd7a5e0f37a1fe05852bdd1b88a8b47f185e1bf71', class: {
                [CSS.container]: true,
                [CSS.containerOpen]: opened,
                [CSS.containerEmbedded]: this.embedded,
            }, ref: this.setContainerEl }, this.modal ? (h("calcite-scrim", { class: CSS.scrim, onClick: this.handleOutsideClose })) : null, h("div", { key: 'f0236b163b7f7856033c581b9191d0fc491eee46', "aria-description": description, "aria-label": heading, "aria-modal": toAriaBoolean(this.modal), class: CSS.dialog, onKeyDown: this.handleKeyDown, ref: this.setTransitionEl, role: "dialog" }, assistiveText ? (h("div", { "aria-live": "polite", class: CSS.assistiveText, key: "assistive-text" }, assistiveText)) : null, h("slot", { key: 'b0d18a7ce3e4ad5df276b8f04f41284bbe55efff', name: SLOTS.content }, h("calcite-panel", { key: '65bcc069837d6749c84351d7ca29c82e112ff809', beforeClose: this.beforeClose, class: CSS.panel, closable: !this.closeDisabled, closed: !opened, description: description, heading: heading, headingLevel: this.headingLevel, loading: this.loading, menuOpen: this.menuOpen, messageOverrides: this.messageOverrides, onCalcitePanelClose: this.handleInternalPanelCloseClick, onCalcitePanelScroll: this.handleInternalPanelScroll, onKeyDown: this.handlePanelKeyDown, overlayPositioning: this.overlayPositioning, ref: (el) => (this.panelEl = el), scale: this.scale }, h("slot", { key: '90a1b0007537031a9c1ae3761f48d05d3dd62d78', name: SLOTS.actionBar, slot: SLOTS$1.actionBar }), h("slot", { key: 'b32c13fd7cf274e1fb9ffa071a7406e1a26e0b72', name: SLOTS.alerts, slot: SLOTS$1.alerts }), h("slot", { key: 'd3433c5b0ed4ec801950a72cea50f61efa9b6b8e', name: SLOTS.headerActionsStart, slot: SLOTS$1.headerActionsStart }), h("slot", { key: '164df8e6a746f0e351c629193c5052a3f9254e48', name: SLOTS.headerActionsEnd, slot: SLOTS$1.headerActionsEnd }), h("slot", { key: 'e67304954b705afe57384f27214ecab5b89eaed9', name: SLOTS.headerContent, slot: SLOTS$1.headerContent }), h("slot", { key: 'b4108e58478e2e4e00494c8c8e7b1790804f55ee', name: SLOTS.headerMenuActions, slot: SLOTS$1.headerMenuActions }), h("slot", { key: 'c9b54cd7003e3ff18c000fb32215b9dd0de6586e', name: SLOTS.fab, slot: SLOTS$1.fab }), h("slot", { key: 'bf3b9d2fcbbda75832d3c27a4a5118b7eca0c891', name: SLOTS.contentTop, slot: SLOTS$1.contentTop }), h("slot", { key: 'db86d0c4aa3b8655e6566462d47c33d2ae2a8518', name: SLOTS.contentBottom, slot: SLOTS$1.contentBottom }), h("slot", { key: '98d5f7a2864e00b5f5a13110b892c7f52c12cf93', name: SLOTS.footerStart, slot: SLOTS$1.footerStart }), h("slot", { key: '8a104a39303414390b745f23987466abaa7a874c', name: SLOTS.footer, slot: SLOTS$1.footer }), h("slot", { key: '15673502ce16cab5f70c6be6204c8b9d59c3ce88', name: SLOTS.footerEnd, slot: SLOTS$1.footerEnd }), h("slot", { key: '7dfb7dd86d4019c9256adccc7b16554b9fe0a05c' })))))));
    }
    ...
    updateTransform() {
        const { dragPosition: { x, y }, resizePosition, transitionEl, } = this;
        if (!transitionEl) {
            return;
        }
...
Dialog.style = CalciteDialogStyle0;

export { Dialog as calcite_dialog };

//# sourceMappingURL=calcite-dialog.entry.js.map