 ...
 * v2.12.1
 */
import { r as registerInstance, c as createEvent, h, g as getElement, H as Host } from './index-590f87c2.js';
import { b as slotChangeHasAssignedElement, t as toAriaBoolean, G as getFirstTabbable, g as getElementDir } from './dom-0dfcce02.js';
import { c as connectInteractive, u as updateHostInteraction, d as disconnectInteractive, I as InteractiveContainer } from './interactive-7dc921d0.js';
import { c as createObserver } from './observers-aea7721f.js';
import { i as isBrowser } from './browser-b3aa6d44.js';
import { d as disconnectSortableComponent, c as connectSortableComponent } from './sortableComponent-927f5f15.js';
import { S as SLOTS$2 } from './resources-702133f3.js';
import { s as setUpLoadableComponent, a as setComponentLoaded, c as componentFocusable } from './loadable-907717a5.js';
import { c as connectMessages, s as setUpMessages, d as disconnectMessages, u as updateMessages } from './t9n-249fa143.js';
import { c as connectLocalized, d as disconnectLocalized, n as numberStringFormatter } from './locale-4ce3c6b2.js';
import { d as debounce } from './debounce-87018c17.js';
import './guid-c5ea645c.js';
import './resources-988e2a52.js';
import './key-6b945008.js';
...
const List = class {
    ...
    render() {
        ...
        return (h(InteractiveContainer, { key: '84991009060a8b97b9901ca97f32b32fa6e830fa', disabled: this.disabled }, h("div", { key: '27f5a904be599be5768bb1a7693111573e745e0f', class: CSS$1.container }, this.dragEnabled ? (h("span", { "aria-live": "assertive", class: CSS$1.assistiveText }, this.assistiveText)) : null, this.renderItemAriaLive(), loading ? h("calcite-scrim", { class: CSS$1.scrim, loading: loading }) : null, h("table", { key: 'dd343a43f26edcb50f87a064a41471756a94afeb', "aria-busy": toAriaBoolean(loading), "aria-label": label || "", class: CSS$1.table, onKeyDown: this.handleListKeydown, role: "treegrid" }, filterEnabled || hasFilterActionsStart || hasFilterActionsEnd ? (h("thead", { class: CSS$1.sticky }, h("tr", null, h("th", { colSpan: MAX_COLUMNS }, h("calcite-stack", { class: CSS$1.stack }, h("slot", { name: SLOTS.filterActionsStart, onSlotchange: this.handleFilterActionsStartSlotChange, slot: SLOTS$2.actionsStart }), h("calcite-filter", { "aria-label": filterPlaceholder, disabled: disabled, filterProps: filterProps, items: dataForFilter, onCalciteFilterChange: this.handleFilterChange, placeholder: filterPlaceholder, ref: this.setFilterEl, value: filterText }), h("slot", { name: SLOTS.filterActionsEnd, onSlotchange: this.handleFilterActionsEndSlotChange, slot: SLOTS$2.actionsEnd })))))) : null, h("tbody", { key: '90a288eea3e02d5261e369e14b687852c1ff876b', class: CSS$1.tableContainer }, h("slot", { key: '08992c3c5ad4d5afe86e7e1cd38327c5f4281bd1', onSlotchange: this.handleDefaultSlotChange }))), h("div", { key: '689185b56a2990e00a409ddbc4e4c135115791d3', "aria-live": "polite", "data-test-id": "no-results-container", hidden: !(hasFilterNoResults && filterEnabled && filterText && !filteredItems.length) }, h("slot", { key: '929ef7f843f5c8e7290a3cbcebea8c5c4cf38707', name: SLOTS.filterNoResults, onSlotchange: this.handleFilterNoResultsSlotChange })))));
    }
    // --------------------------------------------------------------------------
    //
    //  Private Methods
    ...
    renderItemAriaLive() {
        ...
        return !parentListEl ? (h("div", { "aria-live": "polite", class: CSS$1.assistiveText }, filterEnabled && filterText && filteredData?.length ? (h("div", { key: "aria-filter-enabled" }, messages.filterEnabled)) : null, h("div", { key: "aria-item-count" }, messages.total.replace("{count}", numberStringFormatter.localize(filteredItems.length.toString()))), filteredItems.length ? (h("ol", { key: "aria-item-list" }, filteredItems.map((item) => (h("li", null, item.label))))) : null)) : null;
    }
    connectObserver() {
...
const ListItem = class {
    ...
    renderSelected() {
        ...
        return (h("td", { class: {
                [CSS$2.selectionContainer]: true,
                [CSS$2.selectionContainerSingle]: selectionMode === "single" || selectionMode === "single-persist",
    ...
    renderOpen() {
        ...
        return openable ? (h("td", { class: CSS$2.openContainer, key: "open-container", onClick: this.handleToggleClick, title: tooltip }, h("calcite-icon", { icon: icon, key: icon, scale: "s" }))) : null;
    }
    renderActionsStart() {
        const { label, hasActionsStart } = this;
        return (h("td", { "aria-label": label, class: CSS$2.actionsStart, hidden: !hasActionsStart, key: "actions-start-container", onFocusin: this.focusCellActionsStart, ref: (el) => (this.actionsStartEl = el), role: "gridcell" }, h("slot", { name: SLOTS$1.actionsStart, onSlotchange: this.handleActionsStartSlotChange })));
    }
    renderActionsEnd() {
        const { label, hasActionsEnd, closable, messages } = this;
        return (h("td", { "aria-label": label, class: CSS$2.actionsEnd, hidden: !(hasActionsEnd || closable), key: "actions-end-container", onFocusin: this.focusCellActionsEnd, ref: (el) => (this.actionsEndEl = el), role: "gridcell" }, h("slot", { name: SLOTS$1.actionsEnd, onSlotchange: this.handleActionsEndSlotChange }), closable ? (h("calcite-action", { appearance: "transparent", class: CSS$2.close, icon: ICONS.close, key: "close-action", label: messages.close, onClick: this.handleCloseClick, text: messages.close })) : null));
    }
    renderContentStart() {
    ...
    renderContentBottom() {
        ...
        return (h("div", { class: CSS$2.contentBottom, hidden: !hasContentBottom }, h("slot", { name: SLOTS$1.contentBottom, onSlotchange: this.handleContentBottomSlotChange })));
    }
    renderDefaultContainer() {
        return (h("div", { class: {
                [CSS$2.nestedContainer]: true,
                [CSS$2.nestedContainerOpen]: this.openable && this.open,
    ...
    render() {
        ...
        return (h(Host, { key: 'e5c6ac9b3b611040a89e45804935c9c6e0edce2d' }, h(InteractiveContainer, { key: '352c056d23f70ef0c5596e9bc447c57dad7523c9', disabled: disabled }, h("div", { key: 'c19950786e18433c5197309442118d72806698a9', class: { [CSS$2.wrapper]: true, [CSS$2.wrapperBordered]: bordered } }, h("tr", { key: 'a77a11612d4b15afdfe0146c2808312de96756bc', "aria-expanded": openable ? toAriaBoolean(open) : null, "aria-label": label, "aria-level": level, "aria-posinset": setPosition, "aria-selected": toAriaBoolean(selected), "aria-setsize": setSize, class: {
                [CSS$2.container]: true,
                [CSS$2.containerHover]: true,
                [CSS$2.containerBorder]: showBorder,
