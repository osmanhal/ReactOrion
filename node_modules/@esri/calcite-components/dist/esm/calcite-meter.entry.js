...
import { s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-907717a5.js';
import { a as afterConnectDefaultValueSet, c as connectForm, d as disconnectForm } from './form-0d9970ac.js';
import { g as getSupportedLocale, n as numberStringFormatter, c as connectLocalized, d as disconnectLocalized } from './locale-4ce3c6b2.js';
import { v as intersects } from './dom-0dfcce02.js';
    ...
    render() {
        ...
        const valueText = valueLabelType === "percent"
            ...
            : unitLabel
                ? textUnitLabel
                : undefined;
        return (h(Host, { key: '63487d7e530d66178ca535feed2ff2c149fef627' }, h("div", { key: '98b299ee370f14bdb266e69d9b9c8d303b580de9', "aria-label": label, "aria-valuemax": rangeLabelType === "percent" ? maxPercent : max, "aria-valuemin": rangeLabelType === "percent" ? minPercent : min, "aria-valuenow": valueLabelType === "percent" ? currentPercent : value, "aria-valuetext": valueText, class: {
                [CSS.container]: true,
