 ...
 * v2.12.1
 */
import { h, r as registerInstance, c as createEvent, H as Host, e as readTask, g as getElement } from './index-590f87c2.js';
import { s as slotChangeGetAssignedElements, k as focusElementInGroup } from './dom-0dfcce02.js';
...
const Stepper = class {
    ...
    render() {
        return (h(Host, { key: 'bd7571b5c3af662f4a2bde52e9742e2328fc7c8f', "aria-label": this.messages.label, role: "region" }, h("div", { key: '9e1d066b9f3ec7fa1df9f55e6e742d0c26cd4ec2', class: { container: true, [CSS$2.singleView]: this.layout === "horizontal-single" }, ref: this.setContainerEl }, this.layout === "horizontal-single" && (h("div", { key: '49ccb52be5e2c1c747cbe634d3049fc5677ac7c2', class: { [CSS$2.stepBarContainer]: true } }, this.items.map((item, index) => (h(StepBar, { active: index === this.currentActivePosition, complete: item.complete && index !== this.currentActivePosition && !item.error, disabled: item.disabled && index !== this.currentActivePosition, error: item.error && index !== this.currentActivePosition, key: index }))))), this.layout === "horizontal-single" && (h("div", { key: 'd771370bda9cfc17412208ea9de36c52f9c9fabd', class: { [CSS$2.actionContainer]: true } }, this.renderAction("start"), this.renderAction("end"))), h("slot", { key: '8c9f00eda6193622c72943bc459b8e3adf69fe77', onSlotchange: this.handleDefaultSlotChange }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const StepperItem = class {
    ...
    render() {
        return (h(Host, { key: 'f5ff885f8c94eb0a49e786a798ddfa9a4cadf3c8', "aria-current": this.selected ? "step" : "false", onClick: this.handleItemClick, onKeyDown: this.keyDownHandler, tabIndex: this.disabled ? -1 : 0 }, h(InteractiveContainer, { key: '628ba67b4d9afdd89589803c8370b916ef2a64f4', disabled: this.disabled }, h("div", { key: '0e5a38c093eb3f4d83901cab7528b47af683d0c2', class: CSS.container }, this.complete && (h("span", { key: '0b8a733f8d8f5ea684477afaeb3bef9c75204eac', "aria-live": "polite", class: CSS.visuallyHidden }, this.messages.complete)), h("div", { key: '33fda93666886ff0a4704a090142061b0710ea2c', class: CSS.stepperItemHeader, ref: (el) => (this.headerEl = el), tabIndex: 
            /* additional tab index logic needed because of display: contents */
            this.layout === "horizontal" && !this.disabled ? 0 : null }, this.icon ? this.renderIcon() : null, this.numbered ? (h("div", { class: CSS.stepperItemNumber }, this.renderNumbers(), ".")) : null, h("div", { key: '728402fe3cc024aa27080d0e5b26cad009dc0989', class: CSS.stepperItemHeaderText }, h("span", { key: '1be0b998ddf355de099379c2a55d21e0ffe46610', class: CSS.stepperItemHeading }, this.heading), h("span", { key: '20099dd36c9a72c5712b42761ecdf3592ea4a4e8', class: CSS.stepperItemDescription }, this.description))), h("div", { key: 'be67567d400cfea65bf9fcc8950daff2eea80c8b', class: CSS.stepperItemContent }, h("slot", { key: 'd0ccc7d7b5b7caa325a216c293aecfe6d3e983bb' }))))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
