...
import { b as slotChangeHasAssignedElement, s as slotChangeGetAssignedElements, f as focusFirstTabbable, t as toAriaBoolean } from './dom-0dfcce02.js';
...
import { S as SLOTS$1 } from './resources-2bb14228.js';
...
import { S as SLOTS, C as CSS, I as IDS, a as ICONS } from './resources-480def39.js';
...
const Panel = class {
    ...
    render() {
        ...
        const panelNode = (h("article", { key: '94df4953da14ffe331994b99f62c18fdaa3b900b', "aria-busy": toAriaBoolean(loading), class: CSS.container, hidden: isClosed, ref: this.setContainerRef }, this.renderHeaderNode(), this.renderContent(), this.renderContentBottom(), this.renderFooterNode(), h("slot", { key: "alerts", name: SLOTS.alerts, onSlotchange: this.handleAlertsSlotChange })));
        return (h(Host, { key: '01e56f24f7ad90c69f1415f4417b35ed9539e58d', onKeyDown: panelKeyDownHandler }, h(InteractiveContainer, { key: '6274bdb95260746ce36cd731d363a2d3447cfe80', disabled: disabled }, loading ? h("calcite-scrim", { loading: loading }) : null, panelNode)));
    }
...
//# sourceMappingURL=calcite-panel.entry.js.map