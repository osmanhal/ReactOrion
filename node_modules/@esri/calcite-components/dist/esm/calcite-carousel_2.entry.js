...
import { s as slotChangeGetAssignedElements, k as focusElementInGroup, t as toAriaBoolean, g as getElementDir, B as whenAnimationDone } from './dom-0dfcce02.js';
...
import { g as getRoundRobinIndex } from './array-49c05b50.js';
...
const Carousel = class {
    constructor(hostRef) {
        ...
        this.renderPaginationItems = () => (h("div", { "aria-label": this.label, class: CSS$1.paginationItems, role: "tablist" }, this.items.map((item, index) => {
...
//# sourceMappingURL=calcite-carousel_2.entry.js.map