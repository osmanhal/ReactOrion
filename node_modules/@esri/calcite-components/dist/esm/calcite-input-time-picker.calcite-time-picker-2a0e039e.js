 ...
 * v2.12.1
 */
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './index-590f87c2.js';
import { s as submitForm, c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-0d9970ac.js';
import { g as guid } from './guid-c5ea645c.js';
...
import { c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-907717a5.js';
import { n as numberStringFormatter, f as getDateTimeFormat, i as isValidNumber, e as getSupportedNumberingSystem, g as getSupportedLocale, c as connectLocalized, d as disconnectLocalized } from './locale-4ce3c6b2.js';
import { a as activateFocusTrap, d as deactivateFocusTrap, c as connectFocusTrap } from './focusTrapComponent-4c78325e.js';
import { d as decimalPlaces, g as getDecimals } from './math-db618c8a.js';
import { u as updateMessages, c as connectMessages, s as setUpMessages, d as disconnectMessages } from './t9n-249fa143.js';
import { g as getIconScale } from './component-3035aa13.js';
import { V as Validation } from './Validation-c0354df6.js';
import { f as focusFirstTabbable, t as toAriaBoolean } from './dom-0dfcce02.js';
...
const supportedDayjsLocaleToLocaleConfigImport = new Map([
    ["ar", () => import('./ar-00de17c8.js')],
    ["bg", () => import('./bg-92447126.js')],
    ["bs", () => import('./bs-eeaa6fdb.js')],
    ["ca", () => import('./ca-e90cb5d4.js')],
    ["cs", () => import('./cs-ee8b0685.js')],
    ["da", () => import('./da-6b8b7b28.js')],
    ["de", () => import('./de-0c82ecd5.js')],
    ["de-at", () => import('./de-at-7b7c2385.js')],
    ["de-ch", () => import('./de-ch-f7f87ddd.js')],
    ["el", () => import('./el-421f944b.js')],
    ["en", () => Promise.resolve().then(function () { return en$1; })],
    ["en-au", () => import('./en-au-4d82af89.js')],
    ["en-ca", () => import('./en-ca-12db5ae1.js')],
    ["en-gb", () => import('./en-gb-748608d7.js')],
    ["es", () => import('./es-454645a3.js')],
    ["es-mx", () => import('./es-mx-c708130c.js')],
    ["et", () => import('./et-9bd38edf.js')],
    ["fi", () => import('./fi-d6544abc.js')],
    ["fr", () => import('./fr-5d31bb87.js')],
    ["fr-ch", () => import('./fr-ch-8e1ccf92.js')],
    ["he", () => import('./he-221c0f2a.js')],
    ["hi", () => import('./hi-bd4136e2.js')],
    ["hr", () => import('./hr-a93aef09.js')],
    ["hu", () => import('./hu-4ff56814.js')],
    ["id", () => import('./id-26584c79.js')],
    ["it", () => import('./it-c6ba0372.js')],
    ["it-ch", () => import('./it-ch-e6cfac79.js')],
    ["ja", () => import('./ja-6a432ef4.js')],
    ["ko", () => import('./ko-19258c18.js')],
    ["lt", () => import('./lt-a2e394f8.js')],
    ["lv", () => import('./lv-1ef4d861.js')],
    ["mk", () => import('./mk-a466b717.js')],
    ["nl", () => import('./nl-c3618f5a.js')],
    ["nb", () => import('./nb-85d76743.js')],
    ["pl", () => import('./pl-2dd97dd0.js')],
    ["pt", () => import('./pt-2742f10c.js')],
    ["pt-br", () => import('./pt-br-860be5eb.js')],
    ["ro", () => import('./ro-dcc77b89.js')],
    ["ru", () => import('./ru-b4ada174.js')],
    ["sk", () => import('./sk-3876e4cb.js')],
    ["sl", () => import('./sl-0505a2b4.js')],
    ["sr", () => import('./sr-e98c7781.js')],
    ["sv", () => import('./sv-2fcf5ec4.js')],
    ["th", () => import('./th-a4a22c04.js')],
    ["tr", () => import('./tr-1f771866.js')],
    ["uk", () => import('./uk-b188d290.js')],
    ["vi", () => import('./vi-18a725aa.js')],
    ["zh-cn", () => import('./zh-cn-0f84da65.js')],
    ["zh-hk", () => import('./zh-hk-668e5f6d.js')],
    ["zh-tw", () => import('./zh-tw-0d871ca7.js')],
]);
...
const InputTimePicker = class {
    ...
    render() {
        ...
        return (h(Host, { key: '5bf59228db214a262663f204d9633c77b969dcc2', onBlur: this.hostBlurHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: '0ba712e725695bfae5c3d2bcfe151f5b3abe0baa', disabled: this.disabled }, h("div", { key: 'ac841ee97c7e970353494103f22ad596d7e8d080', class: "input-wrapper", onClick: this.onInputWrapperClick }, h("calcite-input-text", { key: 'd5e3ee19763195c57b75f7001301d9233d011c94', "aria-autocomplete": "none", "aria-errormessage": IDS.validationMessage, "aria-haspopup": "dialog", "aria-invalid": toAriaBoolean(this.status === "invalid"), disabled: disabled, icon: "clock", id: this.referenceElementId, label: getLabelText(this), lang: this.effectiveLocale, onCalciteInputTextInput: this.calciteInternalInputInputHandler, onCalciteInternalInputTextFocus: this.calciteInternalInputFocusHandler, readOnly: readOnly, ref: this.setInputEl, role: "combobox", scale: this.scale, status: this.status }), !this.readOnly && this.renderToggleIcon(this.open)), h("calcite-popover", { key: 'c86106dcc1410ec7be8fdf4ced44a00a2bf3aa93', focusTrapDisabled: true, id: dialogId, label: messages.chooseTime, lang: this.effectiveLocale, onCalcitePopoverBeforeClose: this.popoverBeforeCloseHandler, onCalcitePopoverBeforeOpen: this.popoverBeforeOpenHandler, onCalcitePopoverClose: this.popoverCloseHandler, onCalcitePopoverOpen: this.popoverOpenHandler, overlayPositioning: this.overlayPositioning, placement: this.placement, ref: this.setCalcitePopoverEl, referenceElement: this.referenceElementId, triggerDisabled: true }, h("calcite-time-picker", { key: '85d96849fc7e3859a72d2e738a67307d16faadb2', lang: this.effectiveLocale, messageOverrides: this.messageOverrides, numberingSystem: this.numberingSystem, onCalciteInternalTimePickerChange: this.timePickerChangeHandler, ref: this.setCalciteTimePickerEl, scale: this.scale, step: this.step, tabIndex: this.open ? undefined : -1, value: this.value })), h(HiddenFormInputSlot, { key: 'd63640ad5ab2acae003d02c7e22938e1875004cf', component: this }), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
...
//# sourceMappingURL=calcite-input-time-picker.calcite-time-picker-2a0e039e.js.map