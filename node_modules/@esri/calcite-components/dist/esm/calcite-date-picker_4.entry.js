 ...
 * v2.12.1
 */
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, F as Fragment } from './index-590f87c2.js';
import { j as getDaysDiff, c as dateToISO, e as dateFromISO, g as getValueAsDateRange, f as dateFromRange, h as getLocaleData, s as setEndOfDay, k as sameDate, i as inRange, l as getOrder, n as nextMonth, p as prevMonth, m as formatCalendarYear, o as parseCalendarYear } from './utils-9489087b.js';
import { c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-907717a5.js';
import { c as connectLocalized, d as disconnectLocalized, n as numberStringFormatter, f as getDateTimeFormat } from './locale-4ce3c6b2.js';
import { c as connectMessages, d as disconnectMessages, s as setUpMessages, u as updateMessages } from './t9n-249fa143.js';
import { i as isBrowser } from './browser-b3aa6d44.js';
import { a as closestElementCrossShadowBoundary, t as toAriaBoolean } from './dom-0dfcce02.js';
import { I as InteractiveContainer, c as connectInteractive, u as updateHostInteraction, d as disconnectInteractive } from './interactive-7dc921d0.js';
...
const DatePickerDay = class {
    ...
    render() {
        ...
        return (h(Host, { key: '21762e1ba60bf298f05cb5c0499eb57bfc5a279d', "aria-disabled": toAriaBoolean(this.disabled), "aria-label": dayLabel, "aria-selected": toAriaBoolean(this.active), id: dayId, onClick: this.onClick, onKeyDown: this.keyDownHandler, role: "button", tabIndex: this.active && !this.disabled ? 0 : -1 }, h(InteractiveContainer, { key: '449226e496db81d7a029172ae69e1bf9da229603', disabled: this.disabled }, h("div", { key: '147f12c8bc782776df768e01ab8e6de0a6a2eb9f', "aria-hidden": "true", class: { "day-v-wrapper": true } }, h("div", { key: 'e38b3d2b999df042c92a609474a35ef2937dd024', class: "day-wrapper" }, h("span", { key: 'f8e97122b32053d78ff43ef85771fbeb8ff7b180', class: "day" }, h("span", { key: 'a10f30dea71f9774bdf10b55b3564f54c62e7970', class: "text" }, formattedDay)))))));
    }
    connectedCallback() {
