 ...
 * v2.12.1
 */
import { r as registerInstance, h, F as Fragment, g as getElement, c as createEvent, f as forceUpdate } from './index-590f87c2.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-7bdf6b11.js';
import { b as slotChangeHasAssignedElement, s as slotChangeGetAssignedElements, e as getSlotted, g as getElementDir, u as isPrimaryPointerButton } from './dom-0dfcce02.js';
import { c as connectLocalized, d as disconnectLocalized } from './locale-4ce3c6b2.js';
import { c as clamp } from './math-db618c8a.js';
...
const Shell = class {
    ...
    renderDialogs() {
        return (h("div", { hidden: !this.hasDialogs }, h("slot", { key: "dialogs", name: SLOTS$2.dialogs, onSlotchange: this.handleDialogsSlotChange })));
    }
    renderContent() {
        ...
        const panelBottomSlotNode = (h("slot", { key: "panel-bottom-slot", name: SLOTS$2.panelBottom, onSlotchange: this.handlePanelBottomChange }));
        const panelTopSlotNode = (h("slot", { key: "panel-top-slot", name: SLOTS$2.panelTop, onSlotchange: this.handlePanelTopChange }));
        ...
        const content = this.contentBehind
            ? [
                ...
                h("div", { class: {
                        [CSS$2.contentBehindCenterContent]: true,
                        [CSS$2.contentBottom]: this.hasOnlyPanelBottom,
                    } }, panelTopSlotNode, panelBottomSlotNode, deprecatedCenterRowSlotNode),
            ]
            : [
                h("div", { class: { [CSS$2.content]: true, [CSS$2.contentBottom]: this.hasOnlyPanelBottom }, key: contentContainerKey }, panelTopSlotNode, defaultSlotContainerNode, panelBottomSlotNode, deprecatedCenterRowSlotNode),
            ];
        return content;
    }
    renderMain() {
    ...
    renderPositionedSlots() {
        return (h("div", { class: CSS$2.positionedSlotWrapper }, this.renderAlerts(), this.renderModals(), this.renderDialogs(), this.renderSheets()));
    }
    render() {
...
const ShellCenterRow = class {
    ...
    render() {
        const { el } = this;
        const contentNode = (h("div", { key: '7c40a32627154faa3cbb1caa515f156481b79a7a', class: CSS$1.content }, h("slot", { key: 'fe29fde212e5e65a0e0baf633a086dd8e30b5eb8' })));
