...
import { b as slotChangeHasAssignedElement, t as toAriaBoolean } from './dom-0dfcce02.js';
        ...
        const role = this.selectionMode === "multiple" && this.interactive
            ...
            : this.selectionMode !== "none" && this.interactive
                ...
                : this.interactive
                    ? "button"
                    : undefined;
        return (h(Host, { key: '6d76da5a2ae7a51ceffa4d1ca67d2f610b900a1c' }, h(InteractiveContainer, { key: 'fd0190d60cffb6d0f564a91f55b0e4f69663fb5b', disabled: disabled }, h("div", { key: '825b342318201ee13735f9b6e830f26b0fb4e137', "aria-checked": this.selectionMode !== "none" && this.interactive
            ...
            }, onClick: this.handleEmittingEvent, ref: (el) => (this.containerEl = el), role: role, tabIndex: disableInteraction ? -1 : 0 }, this.selectionMode !== "none" && this.renderSelectionIcon(), this.renderChipImage(), this.icon && this.renderIcon(), h("span", { key: '0b3d668d66e359ecc3690ad87033e7e49a9250ef', class: CSS.title }, h("slot", { key: 'ff1af06039b94df6108f5e371e23ad9debfd388e', onSlotchange: this.handleDefaultSlotChange })), this.closable && this.renderCloseButton()))));
    }
