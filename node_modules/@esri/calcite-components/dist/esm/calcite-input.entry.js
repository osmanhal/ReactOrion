 ...
 * v2.12.1
 */
import { r as registerInstance, c as createEvent, f as forceUpdate, h, H as Host, g as getElement } from './index-590f87c2.js';
import { u as isPrimaryPointerButton, h as setRequestedIcon, e as getSlotted, g as getElementDir, t as toAriaBoolean } from './dom-0dfcce02.js';
import { s as submitForm, c as connectForm, i as internalHiddenInputInputEvent, d as disconnectForm, H as HiddenFormInputSlot } from './form-0d9970ac.js';
import { c as connectInteractive, d as disconnectInteractive, u as updateHostInteraction, I as InteractiveContainer } from './interactive-7dc921d0.js';
import { n as numberKeys } from './key-6b945008.js';
import { c as connectLabel, d as disconnectLabel, g as getLabelText } from './label-3e643a13.js';
import { s as setUpLoadableComponent, a as setComponentLoaded, c as componentFocusable } from './loadable-907717a5.js';
import { n as numberStringFormatter, i as isValidNumber, p as parseNumberString, s as sanitizeNumberString, a as addLocalizedTrailingDecimalZeros, c as connectLocalized, d as disconnectLocalized, B as BigDecimal } from './locale-4ce3c6b2.js';
import { c as createObserver } from './observers-aea7721f.js';
import { C as CSS_UTILITY } from './resources-988e2a52.js';
import { u as updateMessages, c as connectMessages, d as disconnectMessages, s as setUpMessages } from './t9n-249fa143.js';
import { g as getIconScale } from './component-3035aa13.js';
import { V as Validation } from './Validation-c0354df6.js';
import { s as syncHiddenFormInput } from './input-30caec30.js';
import './guid-c5ea645c.js';
import './browser-b3aa6d44.js';
...
const Input = class {
    ...
    render() {
        ...
        const loader = (h("div", { key: 'f71fbad6f1d4ac025dd2ebd801883cde41f90bb3', class: CSS.loader }, h("calcite-progress", { key: 'f4a7dccfba5c4a39cb7d9d1bc7b215e85bbdfddc', label: this.messages.loading, type: "indeterminate" })));
        const inputClearButton = (h("button", { key: '1b2b470eedcd68f0af1e026fea1b8ded87949b0f', "aria-label": this.messages.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputValue, tabIndex: -1, type: "button" }, h("calcite-icon", { key: 'b34987e78276f18a361856b949ff110770d9e8b8', icon: "x", scale: getIconScale(this.scale) })));
        const iconEl = (h("calcite-icon", { key: 'e9d94d4380bbe82d693007638a772b3f3e19538e', class: CSS.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: getIconScale(this.scale) }));
        const isHorizontalNumberButton = this.numberButtonType === "horizontal";
        const numberButtonsHorizontalUp = (h("button", { key: '4b57571f699841ab5c465b29b4d677ffd68ca9ef', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "up", disabled: this.disabled || this.readOnly, onPointerDown: this.numberButtonPointerDownHandler, onPointerOut: this.numberButtonPointerUpAndOutHandler, onPointerUp: this.numberButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, h("calcite-icon", { key: '750d67b79ad8c3dfdb7bec8e38efe0f6b150af23', icon: "chevron-up", scale: getIconScale(this.scale) })));
        const numberButtonsHorizontalDown = (h("button", { key: '6cff7df4c63e5c0388244dad1d185d6b6661d5a5', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "down", disabled: this.disabled || this.readOnly, onPointerDown: this.numberButtonPointerDownHandler, onPointerOut: this.numberButtonPointerUpAndOutHandler, onPointerUp: this.numberButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, h("calcite-icon", { key: 'd0dd3b76e18a8c61d02da733f115e945ce67d3e4', icon: "chevron-down", scale: getIconScale(this.scale) })));
        const numberButtonsVertical = (h("div", { key: 'b13c18cd510876510499b305f2fec5fe21b3d5c9', class: CSS.numberButtonWrapper }, numberButtonsHorizontalUp, numberButtonsHorizontalDown));
        const prefixText = h("div", { key: 'c6c1fb7f76df5c032b4f56ccf25589cf7aa6afa5', class: CSS.prefix }, this.prefixText);
        const suffixText = h("div", { key: 'bcfbdaa2e2f0eb409e21ea79661c7fee51284565', class: CSS.suffix }, this.suffixText);
        ...
        const childEl = this.type !== "number"
            ...
            : null;
        return (h(Host, { key: '198e766a57555d29b9e9d44f5a0f10c567e76580', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: '1edb87a044afe283f7d0f05634140c95eedea38d', disabled: this.disabled }, h("div", { key: 'e85d3459d2a562f9e31ae6a30a778eb6d13e7893', class: { [CSS.inputWrapper]: true, [CSS_UTILITY.rtl]: dir === "rtl" }, ref: (el) => (this.inputWrapperEl = el) }, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalDown
            : null, this.prefixText ? prefixText : null, h("div", { key: '75535abc2ee1295fa510dd872dadea8074bcc3d5', class: CSS.wrapper }, localeNumberInput, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), h("div", { key: 'dbdc59f5e4e35e5704e54ddebf67bef0e3a88956', class: CSS.actionWrapper, ref: (el) => (this.actionWrapperEl = el) }, h("slot", { key: '33a1ad6b9e45aeeb8586fe615b41eaa2590660c1', name: SLOTS.action })), this.type === "number" && this.numberButtonType === "vertical" && !this.readOnly
            ? numberButtonsVertical
            : null, this.suffixText ? suffixText : null, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalUp
            : null, h(HiddenFormInputSlot, { key: '36b79e21780048c535ad95ac4e2ad7ab9b3c91e2', component: this })), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
