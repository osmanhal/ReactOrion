...
import { u as updateHostInteraction, I as InteractiveContainer } from './interactive-7dc921d0.js';
import { f as getDateTimeFormat, c as connectLocalized, d as disconnectLocalized } from './locale-4ce3c6b2.js';
...
import { c as connectForm, d as disconnectForm, a as afterConnectDefaultValueSet, H as HiddenFormInputSlot } from './form-0d9970ac.js';
import './dom-0dfcce02.js';
import './guid-c5ea645c.js';
import './resources-988e2a52.js';
import './component-3035aa13.js';
...
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
    if (mode === "name") {
        const { groupByName } = await import('./index-981a9046.js');
    ...
    if (mode === "region") {
        const [{ groupByRegion }, { getCountry }] = await Promise.all([
            import('./index-8db4316a.js'),
            import('./country-ea3c45b5.js'),
        ]);
    ...
    const [{ groupByOffset }, { DateEngine }] = await Promise.all([
        import('./index-e1564c4b.js'),
        import('./index-e80b50ff.js'),
    ]);
...
//# sourceMappingURL=calcite-input-time-zone.entry.js.map