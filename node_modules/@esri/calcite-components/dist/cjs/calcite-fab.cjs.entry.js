...
const Fab = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: 'a3f179f9542d93366d6befded12604369f905580', disabled: disabled }, index.h("calcite-button", { key: '2adc3c8d6408743bfa905995ce75c7ed4d241733', appearance: appearance === "solid" ? "solid" : "outline-fill", class: CSS.button, disabled: disabled, iconFlipRtl: iconFlipRtl ? "start" : null, iconStart: icon, kind: kind, label: label, loading: loading, ref: (buttonEl) => {
