...
const SegmentedControl = class {
    ...
    render() {
        return (index.h(index.Host, { key: '15d2892515a26a3d97657819a2f7e4ec1bfa132b', onClick: this.handleClick, role: "radiogroup" }, index.h("div", { key: '5cf92b36bed0d722d548bbda4804fe3e2a8c0c6a', "aria-errormessage": IDS.validationMessage, "aria-invalid": dom.toAriaBoolean(this.status === "invalid"), class: CSS$1.itemWrapper }, index.h(interactive.InteractiveContainer, { key: '3cdc812ffe33a9651dd4308b8fe8db582e3055de', disabled: this.disabled }, index.h("slot", { key: '4e81e1944e237c65f4bf06b8270a5c23f8c49bd3' }), index.h(form.HiddenFormInputSlot, { key: 'b0ccbb1b76b295ab87912c43b0cbbb936c7fea6e', component: this }))), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status })) : null));
    }
...
const SegmentedControlItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '71f135787c759f1e4ae51c0e0d97164ccfc0b1e1', "aria-checked": dom.toAriaBoolean(checked), "aria-label": value, role: "radio" }, index.h("label", { key: 'e648e7765db0a7e3a4bc5d699475f0883c031c6d', class: {
                [CSS.label]: true,
...
//# sourceMappingURL=calcite-segmented-control_2.cjs.entry.js.map