...
const RadioButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ba3eb165cc92980ff2dbc1ad92b96e05e67c7738', onClick: this.clickHandler, onKeyDown: this.handleKeyDown }, index.h(interactive.InteractiveContainer, { key: 'cc34b939f2d7461239102e360d862e7b770b4f51', disabled: this.disabled }, index.h("div", { key: '9fe5d157ecf61a7dfbb68b174c0a072cafa7fb93', "aria-checked": dom.toAriaBoolean(this.checked), "aria-label": label.getLabelText(this), class: CSS.container, onBlur: this.onContainerBlur, onFocus: this.onContainerFocus, ref: this.setContainerEl, role: "radio", tabIndex: tabIndex }, index.h("div", { key: '82e64cb36cd384a2b05b6768c996cba67490db48', class: "radio" })), index.h(form.HiddenFormInputSlot, { key: 'aec9b59e49dbb867432a4fd006cf32db53306d1c', component: this }))));
    }
