...
const resources$1 = require('./resources-75506554.js');
...
const Panel = class {
    ...
    render() {
        ...
        const panelNode = (index.h("article", { key: '94df4953da14ffe331994b99f62c18fdaa3b900b', "aria-busy": dom.toAriaBoolean(loading), class: resources.CSS.container, hidden: isClosed, ref: this.setContainerRef }, this.renderHeaderNode(), this.renderContent(), this.renderContentBottom(), this.renderFooterNode(), index.h("slot", { key: "alerts", name: resources.SLOTS.alerts, onSlotchange: this.handleAlertsSlotChange })));
        return (index.h(index.Host, { key: '01e56f24f7ad90c69f1415f4417b35ed9539e58d', onKeyDown: panelKeyDownHandler }, index.h(interactive.InteractiveContainer, { key: '6274bdb95260746ce36cd731d363a2d3447cfe80', disabled: disabled }, loading ? index.h("calcite-scrim", { loading: loading }) : null, panelNode)));
    }
