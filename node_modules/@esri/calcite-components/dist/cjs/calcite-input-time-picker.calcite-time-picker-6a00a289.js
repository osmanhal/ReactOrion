...
const locale$1 = require('./locale-8979e43c.js');
const focusTrapComponent = require('./focusTrapComponent-e059d579.js');
const math = require('./math-05b8d5a7.js');
...
const supportedDayjsLocaleToLocaleConfigImport = new Map([
    ["ar", () => Promise.resolve().then(function () { return require('./ar-f0601e20.js'); })],
    ["bg", () => Promise.resolve().then(function () { return require('./bg-0e5f25e3.js'); })],
    ["bs", () => Promise.resolve().then(function () { return require('./bs-3a9adaa3.js'); })],
    ["ca", () => Promise.resolve().then(function () { return require('./ca-c2ab55e9.js'); })],
    ["cs", () => Promise.resolve().then(function () { return require('./cs-f8cbcccb.js'); })],
    ["da", () => Promise.resolve().then(function () { return require('./da-3b2a586d.js'); })],
    ["de", () => Promise.resolve().then(function () { return require('./de-9ae9a8c0.js'); })],
    ["de-at", () => Promise.resolve().then(function () { return require('./de-at-6fd730f0.js'); })],
    ["de-ch", () => Promise.resolve().then(function () { return require('./de-ch-7303a979.js'); })],
    ["el", () => Promise.resolve().then(function () { return require('./el-389c8e92.js'); })],
    ["en", () => Promise.resolve().then(function () { return en$1; })],
    ["en-au", () => Promise.resolve().then(function () { return require('./en-au-b216ab75.js'); })],
    ["en-ca", () => Promise.resolve().then(function () { return require('./en-ca-e6f0bda7.js'); })],
    ["en-gb", () => Promise.resolve().then(function () { return require('./en-gb-d3ecbade.js'); })],
    ["es", () => Promise.resolve().then(function () { return require('./es-751074b1.js'); })],
    ["es-mx", () => Promise.resolve().then(function () { return require('./es-mx-28c2574b.js'); })],
    ["et", () => Promise.resolve().then(function () { return require('./et-1efc2780.js'); })],
    ["fi", () => Promise.resolve().then(function () { return require('./fi-538edf74.js'); })],
    ["fr", () => Promise.resolve().then(function () { return require('./fr-082cfe36.js'); })],
    ["fr-ch", () => Promise.resolve().then(function () { return require('./fr-ch-396dc04e.js'); })],
    ["he", () => Promise.resolve().then(function () { return require('./he-884b76e1.js'); })],
    ["hi", () => Promise.resolve().then(function () { return require('./hi-f876d006.js'); })],
    ["hr", () => Promise.resolve().then(function () { return require('./hr-04839b18.js'); })],
    ["hu", () => Promise.resolve().then(function () { return require('./hu-e8d0b8c9.js'); })],
    ["id", () => Promise.resolve().then(function () { return require('./id-dbd3d320.js'); })],
    ["it", () => Promise.resolve().then(function () { return require('./it-1def7b83.js'); })],
    ["it-ch", () => Promise.resolve().then(function () { return require('./it-ch-f1c661e2.js'); })],
    ["ja", () => Promise.resolve().then(function () { return require('./ja-ad314678.js'); })],
    ["ko", () => Promise.resolve().then(function () { return require('./ko-ab9bd61a.js'); })],
    ["lt", () => Promise.resolve().then(function () { return require('./lt-395a3642.js'); })],
    ["lv", () => Promise.resolve().then(function () { return require('./lv-06f0ddd4.js'); })],
    ["mk", () => Promise.resolve().then(function () { return require('./mk-253ce42c.js'); })],
    ["nl", () => Promise.resolve().then(function () { return require('./nl-100eeab9.js'); })],
    ["nb", () => Promise.resolve().then(function () { return require('./nb-a5f7f5fe.js'); })],
    ["pl", () => Promise.resolve().then(function () { return require('./pl-720103a4.js'); })],
    ["pt", () => Promise.resolve().then(function () { return require('./pt-c739338e.js'); })],
    ["pt-br", () => Promise.resolve().then(function () { return require('./pt-br-18347e01.js'); })],
    ["ro", () => Promise.resolve().then(function () { return require('./ro-386c6772.js'); })],
    ["ru", () => Promise.resolve().then(function () { return require('./ru-cf301821.js'); })],
    ["sk", () => Promise.resolve().then(function () { return require('./sk-315f7462.js'); })],
    ["sl", () => Promise.resolve().then(function () { return require('./sl-34bbc927.js'); })],
    ["sr", () => Promise.resolve().then(function () { return require('./sr-01ec9ac7.js'); })],
    ["sv", () => Promise.resolve().then(function () { return require('./sv-b198342a.js'); })],
    ["th", () => Promise.resolve().then(function () { return require('./th-9be93c47.js'); })],
    ["tr", () => Promise.resolve().then(function () { return require('./tr-5c5442a4.js'); })],
    ["uk", () => Promise.resolve().then(function () { return require('./uk-54619615.js'); })],
    ["vi", () => Promise.resolve().then(function () { return require('./vi-1f52a376.js'); })],
    ["zh-cn", () => Promise.resolve().then(function () { return require('./zh-cn-b2f1c0da.js'); })],
    ["zh-hk", () => Promise.resolve().then(function () { return require('./zh-hk-d7ce16a0.js'); })],
    ["zh-tw", () => Promise.resolve().then(function () { return require('./zh-tw-807a3212.js'); })],
]);
...
const InputTimePicker = class {
    ...
    async effectiveLocaleWatcher(locale) {
        await Promise.all([this.loadDateTimeLocaleData(), t9n.updateMessages(this, this.effectiveLocale)]);
        this.setInputValue(localizeTimeString({
            value: this.value,
            locale,
            numberingSystem: this.numberingSystem,
    ...
    syncHiddenFormInput(input$1) {
        input.syncHiddenFormInput("time", this, input$1);
    }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5bf59228db214a262663f204d9633c77b969dcc2', onBlur: this.hostBlurHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: '0ba712e725695bfae5c3d2bcfe151f5b3abe0baa', disabled: this.disabled }, index.h("div", { key: 'ac841ee97c7e970353494103f22ad596d7e8d080', class: "input-wrapper", onClick: this.onInputWrapperClick }, index.h("calcite-input-text", { key: 'd5e3ee19763195c57b75f7001301d9233d011c94', "aria-autocomplete": "none", "aria-errormessage": IDS.validationMessage, "aria-haspopup": "dialog", "aria-invalid": dom.toAriaBoolean(this.status === "invalid"), disabled: disabled, icon: "clock", id: this.referenceElementId, label: label.getLabelText(this), lang: this.effectiveLocale, onCalciteInputTextInput: this.calciteInternalInputInputHandler, onCalciteInternalInputTextFocus: this.calciteInternalInputFocusHandler, readOnly: readOnly, ref: this.setInputEl, role: "combobox", scale: this.scale, status: this.status }), !this.readOnly && this.renderToggleIcon(this.open)), index.h("calcite-popover", { key: 'c86106dcc1410ec7be8fdf4ced44a00a2bf3aa93', focusTrapDisabled: true, id: dialogId, label: messages.chooseTime, lang: this.effectiveLocale, onCalcitePopoverBeforeClose: this.popoverBeforeCloseHandler, onCalcitePopoverBeforeOpen: this.popoverBeforeOpenHandler, onCalcitePopoverClose: this.popoverCloseHandler, onCalcitePopoverOpen: this.popoverOpenHandler, overlayPositioning: this.overlayPositioning, placement: this.placement, ref: this.setCalcitePopoverEl, referenceElement: this.referenceElementId, triggerDisabled: true }, index.h("calcite-time-picker", { key: '85d96849fc7e3859a72d2e738a67307d16faadb2', lang: this.effectiveLocale, messageOverrides: this.messageOverrides, numberingSystem: this.numberingSystem, onCalciteInternalTimePickerChange: this.timePickerChangeHandler, ref: this.setCalciteTimePickerEl, scale: this.scale, step: this.step, tabIndex: this.open ? undefined : -1, value: this.value })), index.h(form.HiddenFormInputSlot, { key: 'd63640ad5ab2acae003d02c7e22938e1875004cf', component: this }), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
    renderToggleIcon(open) {
        return (index.h("span", { class: CSS$1.toggleIcon }, index.h("calcite-icon", { icon: open ? "chevron-up" : "chevron-down", scale: component.getIconScale(this.scale) })));
    }
...
//# sourceMappingURL=calcite-input-time-picker.calcite-time-picker-6a00a289.js.map