...
const RadioButtonGroup = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (index.h(index.Host, { key: '9a30f9b99f3f7dd6b237d951f71eac2cce3b595f', role: "radiogroup" }, index.h("div", { key: '8e6e1498148c9d25c039e72b73bd3987c782af64', "aria-errormessage": IDS.validationMessage, "aria-invalid": dom.toAriaBoolean(this.status === "invalid"), class: CSS.itemWrapper }, index.h("slot", { key: '8b7a7b9c32e10a15f40495972d4f0b46726f22dc' })), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status })) : null));
    }
