...
const ValueList = class {
    ...
    render() {
        return (index.h(resources.List, { key: '226659128d8b783ff03fabc4ad086291d3ec749c', onBlur: this.handleBlur, onFocusin: this.handleFocusIn, onKeyDown: this.keyDownHandler, props: this }));
    }
...
const ValueListItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5800bb42bb126d69868f664845be9d912cc16a1e', id: this.el.id || this.guid }, index.h(interactive.InteractiveContainer, { key: '3fd26470647b3ec37edaf80d83d8b74b4a0dbcb0', disabled: this.disabled }, this.renderHandle(), index.h("calcite-pick-list-item", { key: '772821bab106c95accaa215e05164371760f2ac0', description: this.description, deselectDisabled: this.deselectDisabled, disabled: this.disabled, label: this.label, metadata: this.metadata, nonInteractive: this.nonInteractive, onCalciteListItemChange: this.handleSelectChange, ref: this.getPickListRef, removable: this.removable, selected: this.selected, value: this.value }, this.renderActionsStart(), this.renderActionsEnd()))));
    }
    get el() { return index.getElement(this); }
};
...
//# sourceMappingURL=calcite-value-list_2.cjs.entry.js.map