...
const observers = require('./observers-40b2a757.js');
const resources = require('./resources-8bcff513.js');
...
const Input = class {
    ...
    connectedCallback() {
        ...
        this.setDisabledAction();
        this.el.addEventListener(form.internalHiddenInputInputEvent, this.onHiddenFormInputInput);
    }
    disconnectedCallback() {
        ...
        this.el.removeEventListener(form.internalHiddenInputInputEvent, this.onHiddenFormInputInput);
    }
    ...
    syncHiddenFormInput(input$1) {
        input.syncHiddenFormInput(this.type, this, input$1);
    }
    setDisabledAction() {
    ...
    render() {
        ...
        const loader = (index.h("div", { key: 'f71fbad6f1d4ac025dd2ebd801883cde41f90bb3', class: CSS.loader }, index.h("calcite-progress", { key: 'f4a7dccfba5c4a39cb7d9d1bc7b215e85bbdfddc', label: this.messages.loading, type: "indeterminate" })));
        const inputClearButton = (index.h("button", { key: '1b2b470eedcd68f0af1e026fea1b8ded87949b0f', "aria-label": this.messages.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputValue, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: 'b34987e78276f18a361856b949ff110770d9e8b8', icon: "x", scale: component.getIconScale(this.scale) })));
        const iconEl = (index.h("calcite-icon", { key: 'e9d94d4380bbe82d693007638a772b3f3e19538e', class: CSS.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: component.getIconScale(this.scale) }));
        const isHorizontalNumberButton = this.numberButtonType === "horizontal";
        const numberButtonsHorizontalUp = (index.h("button", { key: '4b57571f699841ab5c465b29b4d677ffd68ca9ef', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "up", disabled: this.disabled || this.readOnly, onPointerDown: this.numberButtonPointerDownHandler, onPointerOut: this.numberButtonPointerUpAndOutHandler, onPointerUp: this.numberButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: '750d67b79ad8c3dfdb7bec8e38efe0f6b150af23', icon: "chevron-up", scale: component.getIconScale(this.scale) })));
        const numberButtonsHorizontalDown = (index.h("button", { key: '6cff7df4c63e5c0388244dad1d185d6b6661d5a5', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "down", disabled: this.disabled || this.readOnly, onPointerDown: this.numberButtonPointerDownHandler, onPointerOut: this.numberButtonPointerUpAndOutHandler, onPointerUp: this.numberButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: 'd0dd3b76e18a8c61d02da733f115e945ce67d3e4', icon: "chevron-down", scale: component.getIconScale(this.scale) })));
        const numberButtonsVertical = (index.h("div", { key: 'b13c18cd510876510499b305f2fec5fe21b3d5c9', class: CSS.numberButtonWrapper }, numberButtonsHorizontalUp, numberButtonsHorizontalDown));
        const prefixText = index.h("div", { key: 'c6c1fb7f76df5c032b4f56ccf25589cf7aa6afa5', class: CSS.prefix }, this.prefixText);
        const suffixText = index.h("div", { key: 'bcfbdaa2e2f0eb409e21ea79661c7fee51284565', class: CSS.suffix }, this.suffixText);
        ...
        const localeNumberInput = this.type === "number" ? (index.h("input", { accept: this.accept, "aria-errormessage": IDS.validationMessage, "aria-invalid": dom.toAriaBoolean(this.status === "invalid"), "aria-label": label.getLabelText(this), autocomplete: this.autocomplete, autofocus: autofocus, defaultValue: this.defaultValue, disabled: this.disabled ? true : null, enterKeyHint: enterKeyHint, inputMode: inputMode, key: "localized-input", maxLength: this.maxLength, minLength: this.minLength, multiple: this.multiple, name: undefined, onBlur: this.inputBlurHandler, onFocus: this.inputFocusHandler, onInput: this.inputNumberInputHandler, onKeyDown: this.inputNumberKeyDownHandler, onKeyUp: this.inputKeyUpHandler, pattern: this.pattern, placeholder: this.placeholder || "", readOnly: this.readOnly, ref: this.setChildNumberElRef, type: "text", value: this.displayedValue })) : null;
        const childEl = this.type !== "number"
            ? [
                index.h(this.childElType, { accept: this.accept, "aria-errormessage": IDS.validationMessage, "aria-invalid": dom.toAriaBoolean(this.status === "invalid"), "aria-label": label.getLabelText(this), autocomplete: this.autocomplete, autofocus: autofocus, class: {
                ...
                this.isTextarea ? (index.h("div", { class: CSS.resizeIconWrapper }, index.h("calcite-icon", { icon: "chevron-down", scale: component.getIconScale(this.scale) }))) : null,
            ]
            : null;
        return (index.h(index.Host, { key: '198e766a57555d29b9e9d44f5a0f10c567e76580', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: '1edb87a044afe283f7d0f05634140c95eedea38d', disabled: this.disabled }, index.h("div", { key: 'e85d3459d2a562f9e31ae6a30a778eb6d13e7893', class: { [CSS.inputWrapper]: true, [resources.CSS_UTILITY.rtl]: dir === "rtl" }, ref: (el) => (this.inputWrapperEl = el) }, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalDown
            : null, this.prefixText ? prefixText : null, index.h("div", { key: '75535abc2ee1295fa510dd872dadea8074bcc3d5', class: CSS.wrapper }, localeNumberInput, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), index.h("div", { key: 'dbdc59f5e4e35e5704e54ddebf67bef0e3a88956', class: CSS.actionWrapper, ref: (el) => (this.actionWrapperEl = el) }, index.h("slot", { key: '33a1ad6b9e45aeeb8586fe615b41eaa2590660c1', name: SLOTS.action })), this.type === "number" && this.numberButtonType === "vertical" && !this.readOnly
            ? numberButtonsVertical
            : null, this.suffixText ? suffixText : null, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalUp
            : null, index.h(form.HiddenFormInputSlot, { key: '36b79e21780048c535ad95ac4e2ad7ab9b3c91e2', component: this })), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
...
Input.style = CalciteInputStyle0;

exports.calcite_input = Input;

//# sourceMappingURL=calcite-input.cjs.entry.js.map