...
const DropdownItem = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { key: '46fd6784a80e78a149e6796018f495f33c9fe172', class: CSS.iconStart, flipRtl: iconFlipRtl === "start" || iconFlipRtl === "both", icon: this.iconStart, scale: component.getIconScale(this.scale) }));
        const contentNode = (index.h("span", { key: 'feee494a9e26fad963b71e5aacf3abf9084ec463', class: CSS.itemContent }, index.h("slot", { key: '33e49b095819a250f469d457279f6a340ff31fd4' })));
        const iconEndEl = (index.h("calcite-icon", { key: 'ea58bc58292cf76bcda6826e3c402079b0d3ad69', class: CSS.iconEnd, flipRtl: iconFlipRtl === "end" || iconFlipRtl === "both", icon: this.iconEnd, scale: component.getIconScale(this.scale) }));
        const slottedContent = this.iconStart && this.iconEnd
            ...
            : this.iconStart
                ...
                : this.iconEnd
                    ...
                    : contentNode;
        const contentEl = !href ? (slottedContent) : (index.h("a", { "aria-label": label, class: CSS.link, href: href, ref: (el) => (this.childLink = el), rel: this.rel, tabIndex: -1, target: this.target }, slottedContent));
        const itemRole = href
            ? null
...
//# sourceMappingURL=calcite-dropdown_3.cjs.entry.js.map