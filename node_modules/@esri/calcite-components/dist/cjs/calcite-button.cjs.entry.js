...
const Button = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { key: '4d22fe0db49aa06f71162b2ef64d4011b1b818d8', class: { [CSS.icon]: true, [CSS.iconStart]: true }, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: component.getIconScale(this.scale) }));
        const iconEndEl = (index.h("calcite-icon", { key: '95c15bea3179d091058d225e80477956fcb27e63', class: { [CSS.icon]: true, [CSS.iconEnd]: true }, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: component.getIconScale(this.scale) }));
        const contentEl = (index.h("span", { key: '6399f9291ba542a304a2813cda9ad21de0a19c36', class: CSS.content, ref: (el) => (this.contentEl = el) }, index.h("slot", { key: '818ff928ab9c8d722763ec6c1fdbf6b0d60ef210' })));
        return (index.h(interactive.InteractiveContainer, { key: 'a6799ecea681f5e1929237fd26f91cc6895ae291', disabled: this.disabled }, index.h(Tag, { key: '042f056a472a091f4728127d079089dbb262d572', "aria-disabled": childElType === "a" ? dom.toAriaBoolean(this.disabled || this.loading) : null, "aria-expanded": this.el.getAttribute("aria-expanded"), "aria-label": !this.loading ? label.getLabelText(this) : this.messages.loading, "aria-live": "polite", class: {
