...
const InputText = class {
    ...
    syncHiddenFormInput(input$1) {
        input.syncHiddenFormInput("text", this, input$1);
    }
    setDisabledAction() {
    ...
    render() {
        ...
        const loader = (index.h("div", { key: '75e1d143289073aba71c8412dba86e4513ba438a', class: CSS.loader }, index.h("calcite-progress", { key: '17c1a8dfb11db87f62dd7664fb3ef152b14c89bc', label: this.messages.loading, type: "indeterminate" })));
        const inputClearButton = (index.h("button", { key: '8c2fd4a9a50bea3e5c1e3061d275b76f84920e02', "aria-label": this.messages.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputTextValue, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: '359da0464e284f76c85d92888789c6c20e6f6195', icon: "x", scale: component.getIconScale(this.scale) })));
        const iconEl = (index.h("calcite-icon", { key: '643f3c87fb55ffbab119802fa6409263a003d337', class: CSS.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: component.getIconScale(this.scale) }));
        const prefixText = index.h("div", { key: 'd5a48b6b2fef41fef60e6094d25af969fc6b95e3', class: CSS.prefix }, this.prefixText);
        const suffixText = index.h("div", { key: '5b1e442c895c58386790e0fad7de474be4483a1b', class: CSS.suffix }, this.suffixText);
        const childEl = (index.h("input", { key: '6ca205247c77545cca539d0e9e15ecc8a3bd7aeb', "aria-errormessage": IDS.validationMessage, "aria-invalid": dom.toAriaBoolean(this.status === "invalid"), "aria-label": label.getLabelText(this), autocomplete: this.autocomplete, autofocus: this.el.autofocus ? true : null, class: {
        ...
        return (index.h(index.Host, { key: 'ee459d49c166ac8587e9bcff82e469001bfb341d', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: 'b5b5ce9afc9e98b42ad3380057c48d745fe4a69f', disabled: this.disabled }, index.h("div", { key: '957c3665257e600acc1b0804e00c1d4d1786dd8c', class: { [CSS.inputWrapper]: true, [resources.CSS_UTILITY.rtl]: dir === "rtl" }, ref: (el) => (this.inputWrapperEl = el) }, this.prefixText ? prefixText : null, index.h("div", { key: '2f572c83b9816be8763d1c995a523f82013b76cd', class: CSS.wrapper }, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), index.h("div", { key: 'e02221edf4528d5663d3e48fcea5d6e5c1fe12c6', class: CSS.actionWrapper, ref: (el) => (this.actionWrapperEl = el) }, index.h("slot", { key: 'b49d331ad17da7f17bc2f44ee0d61f5b8c45ce93', name: SLOTS.action })), this.suffixText ? suffixText : null, index.h(form.HiddenFormInputSlot, { key: 'b93d1dec9fa8f48620f694e90c4e195e0138d1c6', component: this })), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
