...
const utils = require('./utils-72a862a2.js');
...
const throttle = require('./throttle-e7da8e1e.js');
...
const ColorPicker = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: 'cd7c2469429382b1adee89c87c4774160795203c', disabled: this.disabled }, index.h("div", { key: 'dd6809c82d3ffe64b8eaebd0669e7f61c0ea87d1', class: utils.CSS.container }, index.h("div", { key: '888c08c46fec112861b076c3cf24b9be7b4a66cd', class: utils.CSS.controlAndScope }, index.h("canvas", { key: '23631c824c61abb2a3ca74e35bffc8be0364a052', class: utils.CSS.colorField, onPointerDown: this.handleColorFieldPointerDown, ref: this.initColorField }), index.h("div", { key: 'a5271bbe3c4f45e3cf7736dd8f4201f54420bfb7', "aria-label": vertical ? messages.value : messages.saturation, "aria-valuemax": vertical ? utils.HSV_LIMITS.v : utils.HSV_LIMITS.s, "aria-valuemin": "0", "aria-valuenow": (vertical ? color?.saturationv() : color?.value()) || "0", class: { [utils.CSS.scope]: true, [utils.CSS.colorFieldScope]: true }, onKeyDown: this.handleColorFieldScopeKeyDown, ref: this.storeColorFieldScope, role: "slider", style: {
                top: `${adjustedColorFieldScopeTop || 0}px`,
                left: `${adjustedColorFieldScopeLeft || 0}px`,
            }, tabindex: "0" })), index.h("div", { key: 'eee6c10107513fd46316d2ba7510977b72771cd2', class: utils.CSS.previewAndSliders }, index.h("calcite-color-picker-swatch", { key: '964481e1c6c6c050df076e8cdc9d7e5b2cbeec79', class: utils.CSS.preview, color: selectedColorInHex, scale: this.alphaChannel ? "l" : this.scale }), index.h("div", { key: 'f915032fe532e140005b0ff1253b0a971a17b079', class: utils.CSS.sliders }, index.h("div", { key: '2bcb609ce36df2d0f75abb767ee6dc88c0c9ea3b', class: utils.CSS.controlAndScope }, index.h("canvas", { key: '99e268a194b785a8ec97fed67a523c602def2a94', class: { [utils.CSS.slider]: true, [utils.CSS.hueSlider]: true }, onPointerDown: this.handleHueSliderPointerDown, ref: this.initHueSlider }), index.h("div", { key: '4cdc0f98048a48e070430bf4f1f817571534f31b', "aria-label": messages.hue, "aria-valuemax": utils.HSV_LIMITS.h, "aria-valuemin": "0", "aria-valuenow": color?.round().hue() || utils.DEFAULT_COLOR.round().hue(), class: { [utils.CSS.scope]: true, [utils.CSS.hueScope]: true }, onKeyDown: this.handleHueScopeKeyDown, ref: this.storeHueScope, role: "slider", style: {
...
const ColorPickerSwatch = class {
    ...
    render() {
        ...
        return (index.h("svg", { key: 'b29377be8ce0518f7b0f3691dcb1dda08890dd94', class: classes, xmlns: "http://www.w3.org/2000/svg" }, this.renderSwatch()));
    }
    renderSwatch() {
...
//# sourceMappingURL=calcite-color-picker_3.cjs.entry.js.map