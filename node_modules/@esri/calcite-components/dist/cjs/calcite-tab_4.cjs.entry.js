...
const core = require('./core-41fdf266.js');
...
const Tab = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '781e0b82d69d7ea6b2bd6e15ed0d1c5248f24d05', "aria-labelledby": this.labeledBy, id: id }, index.h("div", { key: '58a6be23b29e8bee598ecf0cd97ef0578fd4e197', class: { [CSS$2.container]: true, [`scale-${this.scale}`]: true }, role: "tabpanel", tabIndex: this.selected ? 0 : -1 }, index.h("section", { key: 'fbff1dec6ca2494f2485528679c14b4b0741abd8', class: CSS$2.content }, index.h("slot", { key: 'fc52db6fd58bd87f137e887837df5c08772809a3' })))));
    }
    connectedCallback() {
...
const TabNav = class {
    ...
    //--------------------------------------------------------------------------
    render() {
        return (index.h(index.Host, { key: 'e2e130cc399d8bb88201f283de2eef17a46882fc', role: "tablist" }, index.h("div", { key: '2beae02bec71c759201063e4820ce19cacd1c432', class: {
            ...
            } }, this.renderScrollButton("start"), index.h("div", { key: '609a5b8efc1bd46810217ab17256aaad7432586b', class: {
                [CSS$1.tabTitleSlotWrapper]: true,
            }, onScroll: this.onTabTitleScroll, onWheel: this.onTabTitleWheel, ref: this.storeTabTitleWrapperRef }, index.h("slot", { key: '7436f2fcacf2b483a77c741a2449f783c9c4c148', onSlotchange: this.onSlotChange })), this.renderScrollButton("end"))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const TabTitle = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { key: '20ea18dabdb4cabe8a032d0799f3c757bc90c91d', class: { [CSS.titleIcon]: true, [CSS.iconStart]: true }, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: component.getIconScale(this.scale) }));
        const iconEndEl = (index.h("calcite-icon", { key: 'ebd3913a334a959e8962addd45e5077ee82f2ca8', class: { [CSS.titleIcon]: true, [CSS.iconEnd]: true }, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: component.getIconScale(this.scale) }));
        return (index.h(index.Host, { key: '58a72fa4a6e961c3414dfe224a4e235892784707', "aria-controls": this.controls, "aria-selected": dom.toAriaBoolean(this.selected), id: id, role: "tab", tabIndex: this.selected && !this.disabled ? 0 : -1 }, index.h(interactive.InteractiveContainer, { key: 'fe7662ade3001579b664772b4672d6bebd06a82b', disabled: this.disabled }, index.h("div", { key: 'ea226b71436922de6bae2e8e542ae0adf08add1b', class: {
                [CSS.container]: true,
                [CSS.containerBottom]: this.position === "bottom",
                [CSS.iconPresent]: !!this.iconStart || !!this.iconEnd,
                [CSS.scale(this.scale)]: true,
            }, hidden: closed, ref: (el) => this.resizeObserver?.observe(el) }, index.h("div", { key: '737609daa04d9dc18b46872c49b82cf211ba9b5a', class: { [CSS.content]: true, [CSS.contentHasText]: this.hasText } }, this.iconStart ? iconStartEl : null, index.h("slot", { key: 'fb500a910e5c6bfcd8571e2d109331dd88f2544d' }), this.iconEnd ? iconEndEl : null), this.renderCloseButton(), index.h("div", { key: '3fd13c6f459e05cea88c40809b7220369866a2b9', class: CSS.selectedIndicator })))));
    }
    renderCloseButton() {
...
const Tabs = class {
    ...
    disconnectedCallback() { }
    render() {
        return (index.h(index.Fragment, { key: '300872682f4f969586b06b6bbfa5cccb5a005e03' }, index.h("slot", { key: '9b8c09c2f93725349a98d13fb0167c88b82ef413', name: SLOTS.titleGroup }), index.h("section", { key: 'bf1b19251ca8ab3ba4c3c3fa15995889d71d9355' }, index.h("slot", { key: 'e1008e065225b4f0cb1b4fbe2ec91ab761db1144', onSlotchange: this.defaultSlotChangeHandler, ref: this.setDefaultSlotRef }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
