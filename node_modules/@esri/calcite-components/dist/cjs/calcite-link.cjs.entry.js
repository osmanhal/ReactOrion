...
const Link = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { key: '98cdfc979033eb5e339557d4d1a2143c9db9481d', class: "calcite-link--icon icon-start", flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: "s" }));
        const iconEndEl = (index.h("calcite-icon", { key: 'df0cfff6b187899330ec32a74132ca9d6ccb71f6', class: "calcite-link--icon icon-end", flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: "s" }));
        const Tag = childElType;
        const role = childElType === "span" ? "link" : null;
        const tabIndex = childElType === "span" ? 0 : null;
        return (index.h(index.Host, { key: 'e0db07bcdf54a1558d2ee5f7d72dc6b3c9b7b4fc', role: "presentation" }, index.h(interactive.InteractiveContainer, { key: '84e1d20ffe03e7776560fa3f3bcc51a0e17c39ca', disabled: this.disabled }, index.h(Tag, { key: '3d37687afd90675d8aab80bce396e765d81b580e', class: { [resources.CSS_UTILITY.rtl]: dir === "rtl" },
            /*
          When the 'download' property of type 'boolean | string' is set to true, the value is "".
          This works around that issue for now.
          */
            download: Tag === "a" && (download === "" || download) ? download : null, href: Tag === "a" && this.href, onClick: this.childElClickHandler, ref: this.storeTagRef, rel: Tag === "a" && this.rel, role: role, tabIndex: tabIndex, target: Tag === "a" && this.target }, this.iconStart ? iconStartEl : null, index.h("slot", { key: '14a04fe0a03318cfa130744530bff8d68450c317' }), this.iconEnd ? iconEndEl : null))));
    }
    //--------------------------------------------------------------------------
    //
    //  Events
