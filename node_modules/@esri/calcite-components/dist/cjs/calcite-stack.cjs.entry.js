...
const Stack = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6469377ccf7311aefda5e864aac7cb5870b24ded' }, index.h("div", { key: 'd897fc4e108392784147cc0c8ed0a4bf5d347ca1', class: resources.CSS.container }, this.renderActionsStart(), this.renderContentStart(), this.renderDefaultContent(), this.renderContentEnd(), this.renderActionsEnd())));
    }
};
