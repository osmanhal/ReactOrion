...
const Filter = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: 'da4ff667fdb02ae8b85c56cd717b416f3256145d', disabled: disabled }, index.h("div", { key: 'f4406a403101afa7c97da11f8408fa464aa8a08c', class: CSS.container }, index.h("label", { key: 'aace74138ebea71058044e05d4fe44cb7ee6beb2' }, index.h("calcite-input", { key: 'cc7dca3364cc73bf42a78d76155477af98d72552', clearable: true, disabled: disabled, icon: ICONS.search, label: this.messages.label, messageOverrides: { clear: this.messages.clear }, onCalciteInputInput: this.inputHandler, onKeyDown: this.keyDownHandler, placeholder: this.placeholder, ref: (el) => {
                this.textInput = el;
