...
const filter = require('./filter-864bd935.js');
...
const XButton = ({ disabled, key, label, onClick, ref, scale, }) => (index.h("button", { "aria-label": label, class: CSS$3.button, disabled: disabled, key: key, onClick: onClick, ref: ref, tabIndex: -1, type: "button" },
