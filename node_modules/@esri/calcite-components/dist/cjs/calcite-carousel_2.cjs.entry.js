...
const array = require('./array-b13eb1c5.js');
...
const Carousel = class {
    constructor(hostRef) {
        ...
        this.calciteCarouselChange = index.createEvent(this, "calciteCarouselChange", 6);
        this.calciteCarouselPlay = index.createEvent(this, "calciteCarouselPlay", 6);
        this.calciteCarouselStop = index.createEvent(this, "calciteCarouselStop", 6);
        this.calciteCarouselPause = index.createEvent(this, "calciteCarouselPause", 6);
        this.calciteCarouselResume = index.createEvent(this, "calciteCarouselResume", 6);
        this.containerId = `calcite-carousel-container-${guid.guid()}`;
        ...
        this.handleSlotChange = (event) => {
            const items = dom.slotChangeGetAssignedElements(event);
            if (items.length < 1) {
                return;
            }
        ...
        this.tabListKeyDownHandler = (event) => {
            ...
            switch (event.key) {
                case "ArrowRight":
                    dom.focusElementInGroup(interactiveItems, currentEl, "next");
                    break;
                case "ArrowLeft":
                    dom.focusElementInGroup(interactiveItems, currentEl, "previous");
                    break;
                case "Home":
                    event.preventDefault();
                    dom.focusElementInGroup(interactiveItems, currentEl, "first");
                    break;
                case "End":
                    event.preventDefault();
                    dom.focusElementInGroup(interactiveItems, currentEl, "last");
                    break;
            }
        };
        ...
        this.renderRotationControl = () => {
            ...
            return (index.h("button", { "aria-label": text, class: {
                    [CSS$1.paginationItem]: true,
                    [CSS$1.autoplayControl]: true,
                }, onClick: this.toggleRotation, title: text }, index.h("calcite-icon", { icon: this.playing ? ICONS.pause : ICONS.play, scale: "s" }), this.playing && (index.h("calcite-progress", { class: CSS$1.autoplayProgress, label: this.messages.carouselItemProgress, value: this.slideDurationRemaining }))));
        };
        this.renderPaginationArea = () => (index.h("div", { class: {
        ...
        this.renderPaginationItems = () => (index.h("div", { "aria-label": this.label, class: CSS$1.paginationItems, role: "tablist" }, this.items.map((item, index$1) => {
            const isMatch = index$1 === this.selectedIndex;
            return (index.h("button", { "aria-controls": !isMatch ? item.id : undefined, "aria-selected": dom.toAriaBoolean(isMatch), class: {
                    [CSS$1.paginationItem]: true,
                    [CSS$1.paginationItemIndividual]: true,
                    [CSS$1.paginationItemSelected]: isMatch,
                }, "data-index": index$1, key: item.id, onClick: this.handleItemSelection, role: "tab", title: item.label }, index.h("calcite-icon", { icon: isMatch ? ICONS.active : ICONS.inactive, scale: "l" })));
        })));
        this.renderArrow = (direction) => {
            ...
            return (index.h("button", { "aria-controls": this.containerId, class: { [CSS$1.paginationItem]: true, [css]: true }, "data-direction": direction, onClick: this.handleArrowClick, title: title }, index.h("calcite-icon", { flipRtl: dir === "rtl", icon: icon, scale: scale })));
        };
        this.autoplay = false;
    ...
    async directionWatcher(direction) {
        ...
        await dom.whenAnimationDone(this.itemContainer, direction === "forward" ? "item-forward" : "item-backward");
        this.direction = "standby";
    }
    playingWatcher() {
    ...
    nextItem(emit) {
        ...
        const nextIndex = array.getRoundRobinIndex(this.selectedIndex + 1, this.items.length);
        this.setSelectedItem(nextIndex, emit);
    }
    previousItem() {
        this.playing = false;
        const prevIndex = array.getRoundRobinIndex(Math.max(this.selectedIndex - 1, -1), this.items.length);
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bff4155cb4358665eb6530b6637322598604d873' }, index.h(interactive.InteractiveContainer, { key: '7a388be689aca07856f350963c33bce1d4e5e278', disabled: this.disabled }, index.h("div", { key: 'c53c92b22ace937c0d2a6568ddd729ccb1b91108', "aria-label": this.label, "aria-live": this.playing ? "off" : "polite", "aria-roledescription": this.messages.carousel, class: {
                [CSS$1.container]: true,
                [CSS$1.containerOverlaid]: this.controlOverlay,
                [CSS$1.containerEdged]: this.arrowType === "edge",
            }, onFocusin: this.handleFocusIn, onFocusout: this.handleFocusOut, onKeyDown: this.containerKeyDownHandler, onMouseEnter: this.handleMouseIn, onMouseLeave: this.handleMouseOut, ref: this.storeContainerRef, role: "group", tabIndex: 0 }, index.h("section", { key: 'cae379b167a37ef82417ab308c7d623300790122', class: {
            ...
            ref: this.storeItemContainerRef }, index.h("slot", { key: 'bf14a67b46e8946e9cafc57a8d0625b65513f702', onSlotchange: this.handleSlotChange })), this.items.length > 1 && this.renderPaginationArea(), this.arrowType === "edge" && this.renderArrow("previous"), this.arrowType === "edge" && this.renderArrow("next")))));
    }
...
exports.calcite_carousel = Carousel;
exports.calcite_carousel_item = CarouselItem;

//# sourceMappingURL=calcite-carousel_2.cjs.entry.js.map