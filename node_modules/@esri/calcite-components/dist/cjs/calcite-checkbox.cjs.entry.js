...
const Checkbox = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '29feebf02ef9c71ea9e6dafe0f5ed11b0cb89848', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: 'e89b0df0f5638181e233bce9c454e48c6963de19', disabled: this.disabled }, index.h("div", { key: '25a91677124b2b77e6e30bf371afce3153c26761', "aria-checked": dom.toAriaBoolean(this.checked), "aria-label": label.getLabelText(this), class: {
                [CSS.toggle]: true,
                [resources.CSS_UTILITY.rtl]: rtl,
            }, onBlur: this.onToggleBlur, onFocus: this.onToggleFocus, ref: (toggleEl) => (this.toggleEl = toggleEl), role: "checkbox", tabIndex: this.disabled ? undefined : 0 }, index.h("svg", { key: '1aae8a62a1f771e2d3e7fb731bae49e608f15617', "aria-hidden": "true", class: CSS.check, viewBox: "0 0 16 16" }, index.h("path", { key: '27ea5db7e99c8f82f5e7773b684f64e9d9a8101a', d: this.getPath() })), index.h("slot", { key: 'c6ea3d961bc6b3b7018378b8044691b88d65f2d3' })), index.h(form.HiddenFormInputSlot, { key: 'bf3c47ad291541078a94dd46205e912622e85411', component: this }))));
    }
