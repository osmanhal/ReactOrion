...
const logger = require('./logger-6db611fa.js');
...
const Modal = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd40092ac4db27ed1c0e6daca0c14fd04ddb31d9a', "aria-describedby": this.contentId, "aria-labelledby": this.titleId, "aria-modal": "true", role: "dialog" }, index.h("div", { key: '4c83a7e297d6fffe5c2474470d5978f82845d6cd', class: {
                [CSS.container]: true,
                [CSS.containerOpen]: this.opened,
                [CSS.containerEmbedded]: this.embedded,
            } }, index.h("calcite-scrim", { key: 'a44f73d132b0b98006f537830d4f4f9aa7d511cd', class: CSS.scrim, onClick: this.handleOutsideClose }), this.renderStyle(), index.h("div", { key: '3c08fd60cb8f90ba69a1293a4525fbd1c0262a02', class: {
                [CSS.modal]: true,
            }, ref: this.setTransitionEl }, index.h("div", { key: '11e69d8bbc52b3cb58eccebb73729fa344b5e734', class: CSS.header }, this.renderCloseButton(), index.h("header", { key: '30a4fb2e0cc53ce639fb40ec1b7956b262a5884c', class: CSS.title }, index.h("slot", { key: '3782f2b397e46f3dd8e0d4253b1071b1d98ffb65', name: CSS.header }))), this.renderContentTop(), index.h("div", { key: '271a0f1f18e0e20614425005ec905201db0ec6db', class: {
                [CSS.content]: true,
                [CSS.contentNoFooter]: !this.hasFooter,
            }, ref: (el) => (this.modalContent = el) }, index.h("slot", { key: 'e5e55e5af91ab8d3971cb74c005656d9beb06e2f', name: SLOTS.content })), this.renderContentBottom(), this.renderFooter()))));
    }
    renderFooter() {
    ...
    renderCloseButton() {
        return !this.closeButtonDisabled ? (index.h("button", { "aria-label": this.messages.close, class: CSS.close, key: "button", onClick: this.handleCloseClick, ref: (el) => (this.closeButtonEl = el), title: this.messages.close }, index.h("calcite-icon", { icon: ICONS.close, scale: component.getIconScale(this.scale) }))) : null;
    }
    renderStyle() {
