...
const Block = class {
    ...
    render() {
        ...
        const headerContent = (index.h("header", { key: '91deb640f5a591cd70dbb6328cdc588a40b600d5', class: { [CSS$1.header]: true, [CSS$1.headerHasText]: !!(heading || description) }, id: IDS$1.header }, this.renderIcon("start"), this.renderContentStart(), this.renderLoaderStatusIcon(), this.renderTitle()));
        ...
        const headerNode = (index.h("div", { key: 'ebba82b4e065978eaa9ed1e59f05ad80843cc9ab', class: CSS$1.headerContainer }, this.dragHandle ? index.h("calcite-handle", { label: heading }) : null, collapsible ? (index.h("button", { "aria-controls": IDS$1.content, "aria-describedby": IDS$1.header, "aria-expanded": collapsible ? dom.toAriaBoolean(open) : null, class: CSS$1.toggle, id: IDS$1.toggle, onClick: this.onHeaderClick, title: toggleLabel }, headerContent, index.h("div", { class: CSS$1.iconEndContainer }, this.renderIcon("end"), index.h("calcite-icon", { class: CSS$1.toggleIcon, icon: collapseIcon, scale: "s" })))) : this.iconEnd ? (index.h("div", null, headerContent, index.h("div", { class: CSS$1.iconEndContainer }, this.renderIcon("end")))) : (headerContent), hasControl ? (index.h("div", { "aria-labelledby": IDS$1.header, class: CSS$1.controlContainer }, index.h("slot", { name: SLOTS.control }))) : null, hasMenuActions ? (index.h("calcite-action-menu", { label: messages.options, overlayPositioning: this.overlayPositioning }, index.h("slot", { name: SLOTS.headerMenuActions }))) : null, this.renderActionsEnd()));
        return (index.h(index.Host, { key: 'b5c12059b36785bf45ce61e7309a35278b928088' }, index.h(interactive.InteractiveContainer, { key: '90a5013ca2e30dadbd76c146700a53391f3aea62', disabled: this.disabled }, index.h("article", { key: '825f15336afb992c7ea8c718b5ffad7c4bf2507e', "aria-busy": dom.toAriaBoolean(loading), class: {
            ...
            } }, headerNode, index.h("section", { key: '4f690563d78615b68a225456aaae593af6adb826', "aria-labelledby": IDS$1.toggle, class: CSS$1.content, hidden: !open, id: IDS$1.content }, this.renderScrim())))));
    }
