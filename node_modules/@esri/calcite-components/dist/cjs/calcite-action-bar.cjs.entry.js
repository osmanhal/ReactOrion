...
const ExpandToggle = require('./ExpandToggle-b4a147dc.js');
...
require('./resources-8f104731.js');
require('./resources-75506554.js');
...
const ActionBar = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b0627d0daa2f500a979aaacc8981814284c437ad', onCalciteActionMenuOpen: this.actionMenuOpenHandler }, index.h("slot", { key: 'b1831e21404b85f1632d47f280d0357f5897ebc7', onSlotchange: this.handleDefaultSlotChange }), this.renderBottomActionGroup()));
    }
