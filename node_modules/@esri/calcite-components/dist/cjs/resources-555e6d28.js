...
const List = ({ props: { disabled, loading, filterEnabled, dataForFilter, handleFilterEvent, filterPlaceholder, filterText, setFilterEl, dragEnabled, storeAssistiveEl, }, ...rest }) => {
    ...
    return (index.h(index.Host, { "aria-busy": dom.toAriaBoolean(loading), role: "menu", ...rest },
        index.h(interactive.InteractiveContainer, { disabled: disabled },
            index.h("section", null,
                ...
                index.h("header", { class: { [CSS$1.sticky]: true } },
                    filterEnabled ? (index.h("calcite-filter", { "aria-label": filterPlaceholder, disabled: disabled, items: dataForFilter, onCalciteFilterChange: handleFilterEvent, placeholder: filterPlaceholder, ref: setFilterEl, value: filterText })) : null,
...
//# sourceMappingURL=resources-555e6d28.js.map