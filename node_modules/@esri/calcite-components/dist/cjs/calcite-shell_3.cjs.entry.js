...
const conditionalSlot = require('./conditionalSlot-09dd72b3.js');
...
const Shell = class {
    ...
    renderDialogs() {
        return (index.h("div", { hidden: !this.hasDialogs }, index.h("slot", { key: "dialogs", name: SLOTS$2.dialogs, onSlotchange: this.handleDialogsSlotChange })));
    }
    renderContent() {
        const { panelIsResizing } = this;
        const defaultSlotNode = index.h("slot", { key: "default-slot" });
        const defaultSlotContainerNode = panelIsResizing ? (index.h("div", { class: CSS$2.contentNonInteractive }, defaultSlotNode)) : (defaultSlotNode);
        const deprecatedCenterRowSlotNode = (index.h("slot", { key: "center-row-slot", name: SLOTS$2.centerRow }));
        const panelBottomSlotNode = (index.h("slot", { key: "panel-bottom-slot", name: SLOTS$2.panelBottom, onSlotchange: this.handlePanelBottomChange }));
        const panelTopSlotNode = (index.h("slot", { key: "panel-top-slot", name: SLOTS$2.panelTop, onSlotchange: this.handlePanelTopChange }));
        ...
        const content = this.contentBehind
            ...
            : [
                index.h("div", { class: { [CSS$2.content]: true, [CSS$2.contentBottom]: this.hasOnlyPanelBottom }, key: contentContainerKey }, panelTopSlotNode, defaultSlotContainerNode, panelBottomSlotNode, deprecatedCenterRowSlotNode),
            ];
        return content;
    }
    renderMain() {
    ...
    renderPositionedSlots() {
        return (index.h("div", { class: CSS$2.positionedSlotWrapper }, this.renderAlerts(), this.renderModals(), this.renderDialogs(), this.renderSheets()));
    }
    render() {
...
const ShellCenterRow = class {
    ...
    render() {
        const { el } = this;
        const contentNode = (index.h("div", { key: '7c40a32627154faa3cbb1caa515f156481b79a7a', class: CSS$1.content }, index.h("slot", { key: 'fe29fde212e5e65a0e0baf633a086dd8e30b5eb8' })));
        ...
        return index.h(index.Fragment, { key: '9e200163d756dc56a18a7a15692b5804bc6fc874' }, children);
    }
    get el() { return index.getElement(this); }
};
...
const ShellPanel = class {
    ...
    render() {
        ...
        const contentNode = (index.h("div", { class: {
            ...
            }, hidden: collapsed, key: "content", ref: this.storeContentEl, style: style }, this.renderHeader(), index.h("div", { class: CSS.contentBody }, index.h("slot", null)), separatorNode));
        const actionBarNode = (index.h("slot", { key: "action-bar", name: SLOTS.actionBar, onSlotchange: this.handleActionBarSlotChange }));
        const mainNodes = [actionBarNode, contentNode];
        if (position === "end") {
            mainNodes.reverse();
        }
        return (index.h("div", { class: { [CSS.container]: true, [CSS.floatAll]: displayMode === "float-all" } }, mainNodes));
    }
    // --------------------------------------------------------------------------
    //
    //  private Methods
...
//# sourceMappingURL=calcite-shell_3.cjs.entry.js.map