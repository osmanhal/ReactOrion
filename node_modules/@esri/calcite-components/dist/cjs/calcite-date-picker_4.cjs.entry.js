...
const Heading = require('./Heading-ea7dfda6.js');
    ...
    render() {
        ...
        const maxDate = this.range && this.activeRange
            ? this.activeRange === "start"
                ...
                : this.maxAsDate
            : this.maxAsDate;
        return (index.h(index.Host, { key: '52087d405fc20cd885910944004caef0e4b4e33b', onBlur: this.resetActiveDates, onKeyDown: this.keyDownHandler }, this.renderCalendar(activeDate, maxDate, minDate, date, endDate)));
    }
...
const DatePickerDay = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '21762e1ba60bf298f05cb5c0499eb57bfc5a279d', "aria-disabled": dom.toAriaBoolean(this.disabled), "aria-label": dayLabel, "aria-selected": dom.toAriaBoolean(this.active), id: dayId, onClick: this.onClick, onKeyDown: this.keyDownHandler, role: "button", tabIndex: this.active && !this.disabled ? 0 : -1 }, index.h(interactive.InteractiveContainer, { key: '449226e496db81d7a029172ae69e1bf9da229603', disabled: this.disabled }, index.h("div", { key: '147f12c8bc782776df768e01ab8e6de0a6a2eb9f', "aria-hidden": "true", class: { "day-v-wrapper": true } }, index.h("div", { key: 'e38b3d2b999df042c92a609474a35ef2937dd024', class: "day-wrapper" }, index.h("span", { key: 'f8e97122b32053d78ff43ef85771fbeb8ff7b180', class: "day" }, index.h("span", { key: 'a10f30dea71f9774bdf10b55b3564f54c62e7970', class: "text" }, formattedDay)))))));
    }
    connectedCallback() {
...
const DatePickerMonth = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { onFocusout: this.disableActiveFocus, onKeyDown: this.keyDownHandler }, index.h("div", { class: "calendar", role: "grid" }, index.h("div", { class: "week-headers", role: "row" }, adjustedWeekDays.map((weekday) => (index.h("span", { class: "week-header", role: "columnheader" }, weekday)))), index.h("div", { class: "week-days", role: "row" }, days.map((day, index) => this.renderDateDay(day, index))))));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
    ...
    renderDateDay({ active, currentMonth, date, day, dayInWeek, ref }, key) {
        ...
        return (index.h("div", { class: "day", key: key, role: "gridcell" }, index.h("calcite-date-picker-day", { active: active, class: {
...
const DatePickerMonthHeader = class {
    ...
    render() {
        return index.h("div", { key: '6e1476a12ba6ea69e21a6e2ad307ed524bdf3841', class: CSS.header }, this.renderContent());
    }
    renderContent() {
        ...
        return (index.h(index.Fragment, null, index.h("a", { "aria-disabled": `${this.prevMonthDate.getMonth() === activeMonth}`, "aria-label": messages.prevMonth, class: CSS.chevron, href: "#", onClick: this.prevMonthClick, onKeyDown: this.prevMonthKeydown, role: "button", tabindex: this.prevMonthDate.getMonth() === activeMonth ? -1 : 0 }, index.h("calcite-icon", { "flip-rtl": true, icon: ICON.chevronLeft, scale: component.getIconScale(this.scale) })), index.h("div", { class: { text: true, [CSS.textReverse]: reverse } }, index.h(Heading.Heading, { class: CSS.month, level: this.headingLevel }, localizedMonth), index.h("span", { class: CSS.yearWrap }, index.h("input", { "aria-label": messages.year, class: {
                year: true,
                [CSS.yearSuffix]: !!suffix,
            }, inputmode: "numeric", maxlength: "4", minlength: "1", onChange: this.onYearChange, onInput: this.onYearInput, onKeyDown: this.onYearKey, pattern: "\\d*", ref: (el) => (this.yearInput = el), type: "text", value: localizedYear }), suffix && index.h("span", { class: CSS.suffix }, suffix))), index.h("a", { "aria-disabled": `${this.nextMonthDate.getMonth() === activeMonth}`, "aria-label": messages.nextMonth, class: CSS.chevron, href: "#", onClick: this.nextMonthClick, onKeyDown: this.nextMonthKeydown, role: "button", tabindex: this.nextMonthDate.getMonth() === activeMonth ? -1 : 0 }, index.h("calcite-icon", { "flip-rtl": true, icon: ICON.chevronRight, scale: component.getIconScale(this.scale) }))));
    }
...
//# sourceMappingURL=calcite-date-picker_4.cjs.entry.js.map