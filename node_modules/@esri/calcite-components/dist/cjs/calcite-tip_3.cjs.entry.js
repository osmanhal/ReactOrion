...
const Tip = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: 'c725e40201c42c904817edcf0f86dc05d09793b9' }, index.h("article", { key: '304a83ee3721636194696546bfd8af359beecbf6', class: CSS$1.container }, this.renderHeader(), this.renderContent()), this.renderDismissButton()));
    }
...
const TipManager = class {
    ...
    render() {
        ...
        return (index.h("section", { "aria-hidden": dom.toAriaBoolean(closed), class: CSS.container, hidden: closed, onKeyDown: this.tipManagerKeyDownHandler, ref: this.storeContainerRef, tabIndex: 0 }, index.h("header", { class: CSS.header }, index.h(Heading.Heading, { class: CSS.heading, level: headingLevel }, groupTitle), index.h("calcite-action", { class: CSS.close, onClick: this.hideTipManager, scale: "m", text: closeLabel }, index.h("calcite-icon", { icon: ICONS.close, scale: "m" }))), index.h("div", { class: {
...
//# sourceMappingURL=calcite-tip_3.cjs.entry.js.map