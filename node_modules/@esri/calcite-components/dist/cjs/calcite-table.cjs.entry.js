...
const Table = class {
    ...
    render() {
        return (index.h(index.Host, { key: '977fbb58c0ee0fdb506ebed869b136767dc43873' }, index.h("div", { key: 'c9c0885932328c3d703abb32632f599404f8ac20', class: CSS.container }, this.selectionMode !== "none" &&
            this.selectionDisplay !== "none" &&
            this.renderSelectionArea(), index.h("div", { key: 'a6b5739bb1b0f6eafeb37959bc21e54374c4da23', class: {
                [CSS.bordered]: this.bordered,
                [CSS.striped]: this.striped || this.zebra,
                [CSS.tableContainer]: true,
            } }, index.h("table", { key: '209d92a0bdd6ca12f8571ba5ca325c993afc247d', "aria-colcount": this.colCount, "aria-multiselectable": this.selectionMode === "multiple", "aria-rowcount": this.allRows?.length, class: { [CSS.tableFixed]: this.layout === "fixed" }, role: this.interactionMode === "interactive" ? "grid" : "table" }, index.h("caption", { key: '099e0d60343af59b0e59f1baf6fbfb36ed4498ad', class: CSS.assistiveText }, this.caption), this.renderTHead(), this.renderTBody(), this.renderTFoot())), this.pageSize > 0 && this.renderPaginationArea())));
    }
...
//# sourceMappingURL=calcite-table.cjs.entry.js.map