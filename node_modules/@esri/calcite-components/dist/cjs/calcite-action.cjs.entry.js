...
const Action = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0e061330c72e61acb61e53d2d94e1478c03c8083' }, index.h(interactive.InteractiveContainer, { key: 'd34028dbfeb72982aa3fe6847663b16672f3e6ea', disabled: disabled }, index.h("button", { key: 'c05c642ffb09bb466c0c4d1be0b8aac79b2dcdff', "aria-busy": dom.toAriaBoolean(loading), "aria-controls": indicator ? indicatorId : null, "aria-disabled": dom.toAriaBoolean(disabled), "aria-label": ariaLabel, "aria-pressed": dom.toAriaBoolean(active), class: buttonClasses, disabled: disabled, id: buttonId, ref: (buttonEl) => (this.buttonEl = buttonEl) }, this.renderIconContainer(), this.renderTextContainer(), !icon && indicator && index.h("div", { class: CSS.indicatorWithoutIcon, key: "indicator-no-icon" })), index.h("slot", { key: '8ab8d03371d7cd7211e5ab1a083b9b7b9017db79', name: SLOTS.tooltip, onSlotchange: this.handleTooltipSlotChange }), this.renderIndicatorText())));
    }
