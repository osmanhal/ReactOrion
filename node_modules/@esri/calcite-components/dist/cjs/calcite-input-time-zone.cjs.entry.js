...
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
    if (mode === "name") {
        const { groupByName } = await Promise.resolve().then(function () { return require('./index-6f5dac8e.js'); });
    ...
    if (mode === "region") {
        const [{ groupByRegion }, { getCountry }] = await Promise.all([
            Promise.resolve().then(function () { return require('./index-f3ade4f4.js'); }),
            Promise.resolve().then(function () { return require('./country-38658f75.js'); }),
        ]);
    ...
    const [{ groupByOffset }, { DateEngine }] = await Promise.all([
        Promise.resolve().then(function () { return require('./index-eb3c9b67.js'); }),
        Promise.resolve().then(function () { return require('./index-83029f58.js'); }),
    ]);
