...
const Tile = class {
    constructor(hostRef) {
        ...
        this.calciteInternalTileKeyEvent = index.createEvent(this, "calciteInternalTileKeyEvent", 6);
        this.calciteTileSelect = index.createEvent(this, "calciteTileSelect", 7);
        this.clickHandler = () => {
            if (this.interactive) {
                this.setFocus();
        ...
        this.handleSlotChange = (event) => {
            ...
            this[`has${slotName}`] = dom.slotChangeHasAssignedElement(event);
        };
    ...
    renderSelectionIcon() {
        ...
        if (selectionAppearance === "icon" && selectionMode !== "none") {
            return (index.h("calcite-icon", { class: CSS.selectionIcon, icon: selected
    ...
    renderTile() {
        ...
        return (index.h("div", { "aria-checked": selectionMode !== "none" && interactive ? dom.toAriaBoolean(this.selected) : undefined, "aria-disabled": disableInteraction ? dom.toAriaBoolean(disabled) : undefined, "aria-label": role && this.label, class: {
                [CSS.container]: true,
            ...
            }, onClick: this.clickHandler, ref: this.setContainerEl, role: role, tabIndex: disableInteraction ? undefined : 0 }, this.renderSelectionIcon(), index.h("div", { class: {
                [CSS.contentContainer]: true,
                [CSS.contentContainerHasContent]: hasContent,
                [CSS.contentContainerHasOnlyContentTopAndBottom]: hasOnlyContentTopAndBottom,
            } }, index.h("slot", { "data-name": "ContentTop", name: SLOTS.contentTop, onSlotchange: this.handleSlotChange }), icon && index.h("calcite-icon", { class: CSS.icon, flipRtl: iconFlipRtl, icon: icon, scale: "l" }), index.h("div", { class: { [CSS.textContentContainer]: true, [CSS.row]: true } }, index.h("slot", { "data-name": "ContentStart", name: SLOTS.contentStart, onSlotchange: this.handleSlotChange }), index.h("div", { class: CSS.textContent }, heading && index.h("div", { class: CSS.heading }, heading), description && index.h("div", { class: CSS.description }, description)), index.h("slot", { "data-name": "ContentEnd", name: SLOTS.contentEnd, onSlotchange: this.handleSlotChange })), index.h("slot", { "data-name": "ContentBottom", name: SLOTS.contentBottom, onSlotchange: this.handleSlotChange }))));
    }
    render() {
        const { disabled } = this;
        return (index.h(interactive.InteractiveContainer, { key: 'f865a9a77fa149a492adf4ccb7d620928ad1991e', disabled: disabled }, this.href ? (index.h("calcite-link", { disabled: disabled, href: this.href }, this.renderTile())) : (this.renderTile())));
    }
    get el() { return index.getElement(this); }
};
Tile.style = CalciteTileStyle0;

exports.calcite_tile = Tile;

//# sourceMappingURL=calcite-tile.cjs.entry.js.map