...
const timeZones = require('./time-zones-7c332bad.js');
const continent = require('./continent-8bd2aed5.js');
...
const generateTimeZoneMetadata = (timeZoneItems, startDate, numberDays, dateEngine) => {
    ...
    return timeZoneItems.map((tzItem) => {
        const { label } = tzItem;
        const continent$1 = continent.extractContinent(label);
...
const getGroupLabelTimeZoneIndices = (rawTZs, max = 5) => {
    const shrinkedTzs = rawTZs.filter(({ label }) => continent.isRegularContinent(continent.extractContinent(label)));
...
exports.groupByOffset = groupByOffset;

//# sourceMappingURL=index-eb3c9b67.js.map