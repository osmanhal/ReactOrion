...
const SplitButton = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: 'ee973a15275bc3f95af17c40a4b8badbe3462d79', disabled: this.disabled }, index.h("div", { key: 'b2c812632a9ae8cd96060fcc6b22d052e957a9a7', class: CSS.container }, index.h("calcite-button", { key: '03a34e04ae9efa7811f1ac9d701fb230de7200a9', appearance: this.appearance, disabled: this.disabled, "icon-end": this.primaryIconEnd ? this.primaryIconEnd : null, "icon-start": this.primaryIconStart ? this.primaryIconStart : null, iconFlipRtl: this.primaryIconFlipRtl ? this.primaryIconFlipRtl : null, kind: this.kind, label: this.primaryLabel, loading: this.loading, onClick: this.calciteSplitButtonPrimaryClickHandler, scale: this.scale, splitChild: "primary", type: "button", width: buttonWidth }, this.primaryText), index.h("div", { key: '1a1cfc004949b54b56cbc0f3076fb48e678ab314', class: CSS.dividerContainer }, index.h("div", { key: 'f38ecc61ec5712fe86924379347285977c285dc5', class: CSS.divider })), index.h("calcite-dropdown", { key: '719ccb5e274a7ccd04855daa1a39be9781fdcb76', disabled: this.disabled, flipPlacements: this.flipPlacements, onClick: this.calciteSplitButtonSecondaryClickHandler, open: this.active, overlayPositioning: this.overlayPositioning, placement: this.placement, scale: this.scale, "width-scale": this.scale }, index.h("calcite-button", { key: '098292b17056e7431adaadc843ecee4a9453bb7a', appearance: this.appearance, disabled: this.disabled, "icon-start": this.dropdownIcon, kind: this.kind, label: this.dropdownLabel, scale: this.scale, slot: "trigger", splitChild: "secondary", type: "button" }), index.h("slot", { key: 'cc73b47cb462df04f3572bb68565513f8abfa8a0' })))));
    }
    get dropdownIcon() {
