 ...
 */
const internalReadTask = index.readTask;
...
function onToggleOpenCloseComponent(component) {
    internalReadTask(() => {
        ...
        dom.whenTransitionDone(component.transitionEl, component.openTransitionProp, () => {
            if (isOpen(component)) {
...
//# sourceMappingURL=openCloseComponent-4f193baa.js.map