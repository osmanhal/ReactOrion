...
declare const useAttachmentsWidget: (component: import("@arcgis/components-controllers").SafeComponentInterface & {
    manager: ControllerManager<import("@arcgis/components-controllers").BaseComponent>;
    el: HTMLElement;
    autoDestroyDisabled?: boolean | undefined;
    destroy?: (() => Promise<void>) | undefined;
} & Pick<__esri.Attachments, "icon" | "label" | "viewModel" | "capabilities" | "displayType" | "graphic"> & {
    ...
    editConstructorProperties(props: __esri.AttachmentsProperties): __esri.AttachmentsProperties | Promise<__esri.AttachmentsProperties>;
} | undefined) => __esri.Attachments;
export declare class ArcgisAttachments implements Use<typeof useAttachmentsWidget> {
    manager: ControllerManager<this>;
    el: HTMLElement;
    widget: __esri.Attachments;
    viewModel: __esri.AttachmentsViewModel;
