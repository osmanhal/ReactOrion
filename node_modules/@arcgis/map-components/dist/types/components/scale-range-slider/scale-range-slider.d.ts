...
declare const useScaleRangeSliderWidget: (component: import("@arcgis/components-controllers").SafeComponentInterface & {
    ...
    editConstructorProperties(props: __esri.ScaleRangeSliderProperties): __esri.ScaleRangeSliderProperties | Promise<__esri.ScaleRangeSliderProperties>;
