...
declare const useFeatureTableWidget: (component: import("@arcgis/components-controllers").SafeComponentInterface & {
    manager: ControllerManager<import("@arcgis/components-controllers").BaseComponent>;
    el: HTMLElement;
    autoDestroyDisabled?: boolean | undefined;
    destroy?: (() => Promise<void>) | undefined;
} & Pick<__esri.FeatureTable, "icon" | "timeZone" | "label" | "viewModel" | "layer" | "description" | "pageSize" | "editingEnabled" | "highlightEnabled" | "attachmentsEnabled" | "autoRefreshEnabled" | "columnReorderingEnabled" | "filterBySelectionEnabled" | "filterGeometry" | "hiddenFields" | "highlightIds" | "menuConfig" | "multiSortEnabled" | "objectIds" | "relatedRecordsEnabled" | "returnGeometryEnabled" | "returnMEnabled" | "returnZEnabled" | "tableTemplate"> & {
