...
declare const useScaleBarWidget: (component: import("@arcgis/components-controllers").SafeComponentInterface & {
    manager: ControllerManager<import("@arcgis/components-controllers").BaseComponent>;
    el: HTMLElement;
    autoDestroyDisabled?: boolean | undefined;
    destroy?: (() => Promise<void>) | undefined;
} & Pick<__esri.ScaleBar, "icon" | "label" | "viewModel" | "unit"> & {
    reactiveUtils?: __esri.reactiveUtils | undefined;
    state?: unknown;
    viewModel?: __esri.ScaleBarViewModel | undefined;
    icon: string | Nil;
    label: string | Nil;
    ...
    editConstructorProperties(props: __esri.ScaleBarProperties): __esri.ScaleBarProperties | Promise<__esri.ScaleBarProperties>;
} | undefined) => __esri.ScaleBar;
export declare class ArcgisScaleBar implements Use<typeof useScaleBarWidget> {
    manager: ControllerManager<this>;
    el: HTMLElement;
    widget: __esri.ScaleBar;
