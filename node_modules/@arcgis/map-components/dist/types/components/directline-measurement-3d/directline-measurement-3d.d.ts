...
declare const useDirectLineMeasurement3dWidget: (component: import("@arcgis/components-controllers").SafeComponentInterface & {
    manager: ControllerManager<import("@arcgis/components-controllers").BaseComponent>;
    el: HTMLElement;
    autoDestroyDisabled?: boolean | undefined;
    destroy?: (() => Promise<void>) | undefined;
} & Pick<__esri.DirectLineMeasurement3D, "icon" | "label" | "viewModel" | "unit" | "unitOptions" | "analysis"> & {
...
export declare class ArcgisDirectLineMeasurement3d implements Use<typeof useDirectLineMeasurement3dWidget> {
    manager: ControllerManager<this>;
    el: HTMLElement;
    widget: __esri.DirectLineMeasurement3D;
    viewModel: __esri.DirectLineMeasurement3DViewModel;
    /**
