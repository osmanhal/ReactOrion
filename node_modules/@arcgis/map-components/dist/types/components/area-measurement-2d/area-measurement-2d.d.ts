...
declare const useAreaMeasurement2dWidget: (component: import("@arcgis/components-controllers").SafeComponentInterface & {
    manager: ControllerManager<import("@arcgis/components-controllers").BaseComponent>;
    el: HTMLElement;
    autoDestroyDisabled?: boolean | undefined;
    destroy?: (() => Promise<void>) | undefined;
} & Pick<__esri.AreaMeasurement2D & {
    viewModel: __esri.Accessor;
}, "icon" | "label" | "viewModel" | "unit" | "unitOptions"> & {
    ...
    editConstructorProperties(props: __esri.AreaMeasurement2DProperties): __esri.AreaMeasurement2DProperties | Promise<__esri.AreaMeasurement2DProperties>;
} | undefined) => __esri.AreaMeasurement2D & {
    viewModel: __esri.Accessor;
};
export declare class ArcgisAreaMeasurement2d implements Use<typeof useAreaMeasurement2dWidget> {
    manager: ControllerManager<this>;
    el: HTMLElement;
    widget: __esri.AreaMeasurement2D & {
        viewModel: __esri.Accessor;
    };
    viewModel: __esri.AreaMeasurement2DViewModel & __esri.Accessor;
    /**
     * If true, the component will not be destroyed automatically when it is
     * disconnected from the document. This is useful when you want to move the
     * component to a different place on the page, or temporary hide it. If this
