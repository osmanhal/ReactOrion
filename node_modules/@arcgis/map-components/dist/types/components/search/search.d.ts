...
declare const useSearchWidget: (component: import("@arcgis/components-controllers").SafeComponentInterface & {
    ...
    editConstructorProperties(props: __esri.widgetsSearchProperties): __esri.widgetsSearchProperties | Promise<__esri.widgetsSearchProperties>;
