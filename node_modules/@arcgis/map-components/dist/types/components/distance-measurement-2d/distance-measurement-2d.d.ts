...
declare const useDistanceMeasurement2dWidget: (component: import("@arcgis/components-controllers").SafeComponentInterface & {
    manager: ControllerManager<import("@arcgis/components-controllers").BaseComponent>;
    el: HTMLElement;
    autoDestroyDisabled?: boolean | undefined;
    destroy?: (() => Promise<void>) | undefined;
} & Pick<__esri.DistanceMeasurement2D, "icon" | "label" | "viewModel" | "unit" | "unitOptions"> & {
...
export declare class ArcgisDistanceMeasurement2d implements Use<typeof useDistanceMeasurement2dWidget> {
    manager: ControllerManager<this>;
    el: HTMLElement;
    widget: __esri.DistanceMeasurement2D;
    viewModel: __esri.DistanceMeasurement2DViewModel;
    /**
     * If true, the component will not be destroyed automatically when it is
     * disconnected from the document. This is useful when you want to move the
     * component to a different place on the page, or temporary hide it. If this
