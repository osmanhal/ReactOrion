...
declare const useWebScene: (component: import("@arcgis/components-controllers").SafeComponentInterface & {
    manager: ControllerManager<import("@arcgis/components-controllers").BaseComponent>;
    el: HTMLElement;
    autoDestroyDisabled?: boolean | undefined;
    destroy?: (() => Promise<void>) | undefined;
} & Pick<__esri.WebScene, "ground" | "clippingArea"> & {
    reactiveUtils?: __esri.reactiveUtils | undefined;
    autoDestroyDisabled: boolean;
    destroy: () => Promise<void>;
}, options?: {
    editConstructorProperties(props: __esri.WebSceneProperties): __esri.WebSceneProperties | Promise<__esri.WebSceneProperties>;
} | undefined) => __esri.WebScene;
declare const useSceneView: (component: import("@arcgis/components-controllers").SafeComponentInterface & {
    manager: ControllerManager<import("@arcgis/components-controllers").BaseComponent>;
    el: HTMLElement;
    autoDestroyDisabled?: boolean | undefined;
    destroy?: (() => Promise<void>) | undefined;
} & Pick<__esri.SceneView, "map" | "constraints" | "extent" | "floors" | "highlightOptions" | "scale" | "viewpoint" | "zoom" | "allLayerViews" | "basemapView" | "fatalError" | "graphics" | "layerViews" | "navigation" | "padding" | "spatialReference" | "theme" | "timeExtent" | "popup" | "clippingArea" | "alphaCompositingEnabled" | "analyses" | "camera" | "environment" | "qualityProfile" | "viewingMode"> & {
    reactiveUtils?: __esri.reactiveUtils | undefined;
    autoDestroyDisabled: boolean;
    destroy: () => Promise<void>;
}, options?: {
    editConstructorProperties(props: __esri.SceneViewProperties): __esri.SceneViewProperties | Promise<__esri.SceneViewProperties>;
} | undefined) => __esri.SceneView;
export declare class ArcgisScene implements Use<typeof useWebScene>, Use<typeof useSceneView> {
     ...
     */
    center: string | Nil | __esri.Point | number[];
    clippingArea: __esri.Extent;
    /**
    ...
    performanceInfo: __esri.SceneViewPerformanceInfo;
    popup: __esri.Popup;
    /**
    ...
    render(): VNode;
    private _setChildElement;
    private _editMapProperties;
    private _editViewProperties;
}
export {};
