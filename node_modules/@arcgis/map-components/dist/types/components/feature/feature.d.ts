...
declare const useFeatureWidget: (component: import("@arcgis/components-controllers").SafeComponentInterface & {
    manager: ControllerManager<import("@arcgis/components-controllers").BaseComponent>;
    el: HTMLElement;
    autoDestroyDisabled?: boolean | undefined;
    destroy?: (() => Promise<void>) | undefined;
} & Pick<__esri.Feature, "icon" | "map" | "spatialReference" | "label" | "viewModel" | "graphic" | "headingLevel" | "defaultPopupTemplateEnabled"> & {
    ...
    editConstructorProperties(props: __esri.FeatureProperties): __esri.FeatureProperties | Promise<__esri.FeatureProperties>;
} | undefined) => __esri.Feature;
export declare class ArcgisFeature implements Use<typeof useFeatureWidget> {
    manager: ControllerManager<this>;
    el: HTMLElement;
    widget: __esri.Feature;
    viewModel: __esri.FeatureViewModel;
    /**
