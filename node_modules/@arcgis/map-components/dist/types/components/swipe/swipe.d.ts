...
declare const useSwipeWidget: (component: import("@arcgis/components-controllers").SafeComponentInterface & {
    manager: ControllerManager<import("@arcgis/components-controllers").BaseComponent>;
    el: HTMLElement;
    autoDestroyDisabled?: boolean | undefined;
    destroy?: (() => Promise<void>) | undefined;
} & Pick<__esri.Swipe, "icon" | "label" | "viewModel" | "direction" | "dragLabel" | "leadingLayers" | "trailingLayers"> & {
    reactiveUtils?: __esri.reactiveUtils | undefined;
    state?: unknown;
    viewModel?: __esri.SwipeViewModel | undefined;
    icon: string | Nil;
    label: string | Nil;
    ...
    editConstructorProperties(props: __esri.SwipeProperties): __esri.SwipeProperties | Promise<__esri.SwipeProperties>;
} | undefined) => __esri.Swipe;
export declare class ArcgisSwipe implements Use<typeof useSwipeWidget> {
    manager: ControllerManager<this>;
    el: HTMLElement;
    widget: __esri.Swipe;
    viewModel: __esri.SwipeViewModel;
    /**
