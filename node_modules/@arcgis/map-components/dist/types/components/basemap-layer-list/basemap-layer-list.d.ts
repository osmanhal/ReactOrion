...
declare const useBasemapLayerListWidget: (component: import("@arcgis/components-controllers").SafeComponentInterface & {
    manager: ControllerManager<import("@arcgis/components-controllers").BaseComponent>;
    el: HTMLElement;
    autoDestroyDisabled?: boolean | undefined;
    destroy?: (() => Promise<void>) | undefined;
} & Pick<__esri.BasemapLayerList, "icon" | "label" | "viewModel" | "headingLevel" | "baseFilterText" | "baseListItemCreatedFunction" | "basemapTitle" | "catalogOptions" | "collapsed" | "dragEnabled" | "editingTitle" | "filterPlaceholder" | "minFilterItems" | "referenceFilterText" | "referenceListItemCreatedFunction" | "selectedItems" | "selectionMode" | "visibilityAppearance"> & {
    ...
    editConstructorProperties(props: __esri.BasemapLayerListProperties): __esri.BasemapLayerListProperties | Promise<__esri.BasemapLayerListProperties>;
} | undefined) => __esri.BasemapLayerList;
export declare class ArcgisBasemapLayerList implements Use<typeof useBasemapLayerListWidget> {
    manager: ControllerManager<this>;
    el: HTMLElement;
    widget: __esri.BasemapLayerList;
    ...
    baseItems: __esri.Collection<__esri.ListItem>;
    baseListItemCreatedFunction: __esri.ListItemCreatedHandler;
    basemapTitle: string;
    catalogLayerList: __esri.CatalogLayerList;
    catalogOptions: __esri.BasemapLayerListCatalogOptions;
    collapsed: boolean;
    dragEnabled: boolean;
    ...
    referenceListItemCreatedFunction: __esri.ListItemCreatedHandler;
    ...
    arcgisReady: EventEmitter<never>;
    widgetTriggerAction: EventEmitter<__esri.BasemapLayerListTriggerActionEvent>;
    arcgisPropertyChange: import("@arcgis/components-controllers").CovariantEventEmitter<{
        name: "state";
    }> & CustomEvent<{
        name: "state";
