...
declare const useSliceWidget: (component: import("@arcgis/components-controllers").SafeComponentInterface & {
    manager: ControllerManager<import("@arcgis/components-controllers").BaseComponent>;
    el: HTMLElement;
    autoDestroyDisabled?: boolean | undefined;
    destroy?: (() => Promise<void>) | undefined;
} & Pick<__esri.Slice, "icon" | "label" | "viewModel" | "analysis" | "headingLevel"> & {
    reactiveUtils?: __esri.reactiveUtils | undefined;
    state?: unknown;
    viewModel?: __esri.SliceViewModel | undefined;
    icon: string | Nil;
    label: string | Nil;
    ...
    editConstructorProperties(props: __esri.SliceProperties): __esri.SliceProperties | Promise<__esri.SliceProperties>;
} | undefined) => __esri.Slice;
export declare class ArcgisSlice implements Use<typeof useSliceWidget> {
    manager: ControllerManager<this>;
    el: HTMLElement;
    widget: __esri.Slice;
    viewModel: __esri.SliceViewModel;
    /**
    ...
    excludedLayers: __esri.Collection<__esri.Layer | __esri.BuildingComponentSublayer>;
    excludeGroundSurface: boolean;
    icon: string;
    label: string;
    headingLevel: number;
    shape: __esri.SlicePlane;
    tiltEnabled: boolean;
    position: __esri.UIPosition;
