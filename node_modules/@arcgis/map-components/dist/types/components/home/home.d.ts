...
import type { HomeStrings } from "./t9n-types";
declare const useHomeViewModel: (component: import("@arcgis/components-controllers").SafeComponentInterface & {
