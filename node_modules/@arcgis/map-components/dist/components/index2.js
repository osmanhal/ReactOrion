...
async function importWidgetsHomeHomeViewModel() {
  ...
  const module = await import('@arcgis/core/widgets/Home/HomeViewModel.js');
  return isDefaultModule(module) ? module.default : module;
}
...
async function importWidgetsOrientedImageryViewer() {
  ...
  const module = await import('@arcgis/core/widgets/OrientedImageryViewer.js');
  return isDefaultModule(module) ? module.default : module;
}
...
export { newWidgetsScaleRangeSlider as $, newWidgetsEditor as A, newWidgetsElevationProfile as B, newWidgetsExpand as C, Deferred as D, newWidgetsFeature as E, newWidgetsFeatureForm as F, newLayersFeatureLayer as G, newWidgetsFeatureTable as H, newWidgetsFeatureTemplates as I, newWidgetsFeatures as J, newWidgetsFloorFilter as K, newWidgetsFullscreen as L, newWidgetsHistogram as M, newWidgetsHistogramRangeSlider as N, classes as O, newWidgetsHomeHomeViewModel as P, newWidgetsLayerList as Q, newWidgetsLegend as R, newWidgetsLineOfSight as S, newWidgetsLocate as T, newWebMap as U, newViewsMapView as V, newWidgetsMeasurement as W, newWidgetsNavigationToggle as X, newWidgetsOrientedImageryViewer as Y, newWidgetsPrint as Z, newWidgetsScaleBar as _, safeCall as a, newWebScene as a0, newViewsSceneView as a1, newWidgetsSearch as a2, newWidgetsShadowCast as a3, newLayersGraphicsLayer as a4, newWidgetsSketch as a5, newWidgetsSlice as a6, newWidgetsSlider as a7, newWidgetsSwipe as a8, newWidgetsTableList as a9, newWidgetsTimeSlider as aa, newWidgetsTrack as ab, newWidgetsUtilityNetworkAssociations as ac, newWidgetsUtilityNetworkTrace as ad, newWidgetsUtilityNetworkValidateTopology as ae, newWidgetsValuePicker as af, newWidgetsVersionManagementVersionManagementViewModel as ag, newWidgetsWeather as ah, newWidgetsZoom as ai, safeAsyncCall as b, camelToKebab as c, devToolsAwareTimeout as d, importCoreAccessorSupportDecorators as e, isNotUndefined as f, getElementLocales as g, importCoreReactiveUtils as h, importCoreAccessor as i, newWidgetsAreaMeasurement3D as j, newWidgetsAttachments as k, newWidgetsBasemapGallery as l, newWidgetsBasemapLayerList as m, newWidgetsAreaMeasurement2D as n, newWidgetsBasemapToggle as o, newWidgetsBookmarks as p, newWidgetsBuildingExplorer as q, newWidgetsCompass as r, startLocaleObserver as s, newWidgetsCoordinateConversion as t, newWidgetsDaylight as u, newWidgetsDirectionalPad as v, newLayersRouteLayer as w, newWidgetsDirections as x, newWidgetsDirectLineMeasurement3D as y, newWidgetsDistanceMeasurement2D as z };
