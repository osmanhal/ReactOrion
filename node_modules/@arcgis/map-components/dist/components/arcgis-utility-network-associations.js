...
import { ac as newWidgetsUtilityNetworkAssociations } from './index2.js';
import { r as referenceElementHelper, d as defineViewProperty, a as attachToParent } from './component-utils.js';
...
const ArcgisUtilityNetworkAssociationsStyle0 = utilityNetworkAssociationsCss;

const ArcgisUtilityNetworkAssociations$1 = /*@__PURE__*/ proxyCustomElement(class ArcgisUtilityNetworkAssociations extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    render() {
        return h("div", { key: '2b1e7613bcebcda7c19c377b2a693ea61e98b9bf', ref: (el) => (this.el.childElem = el) });
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
    ...
    _createParams() {
        ...
        if (this.autoRefreshAssociationsDisabled !== undefined) {
        ...
        if (this.includeConnectivityAssociationsDisabled !== undefined) {
            params.includeConnectivityAssociations = !this.includeConnectivityAssociationsDisabled;
        }
        if (this.includeStructuralAttachmentAssociationsDisabled !== undefined) {
    ...
    static get style() { return ArcgisUtilityNetworkAssociationsStyle0; }
}, [0, "arcgis-utility-network-associations", {
        "referenceElement": [1, "reference-element"],
        "autoRefreshAssociationsDisabled": [4, "auto-refresh-associations-disabled"],
        "connectivityAssociationsLineSymbol": [16],
        "includeConnectivityAssociationsDisabled": [4, "include-connectivity-associations-disabled"],
        "includeStructuralAttachmentAssociationsDisabled": [4, "include-structural-attachment-associations-disabled"],
        ...
        "utilityNetwork": [16],
        "visibleElementsConnectivityAssociationsSettingsArrowsToggle": [4, "visible-elements-connectivity-associations-settings-arrows-toggle"],
        "visibleElementsConnectivityAssociationsSettingsCapSelect": [4, "visible-elements-connectivity-associations-settings-cap-select"],
        "visibleElementsConnectivityAssociationsSettingsColorPicker": [4, "visible-elements-connectivity-associations-settings-color-picker"],
        "visibleElementsConnectivityAssociationsSettingsStylePicker": [4, "visible-elements-connectivity-associations-settings-style-picker"],
        "visibleElementsConnectivityAssociationsSettingsWidthInput": [4, "visible-elements-connectivity-associations-settings-width-input"],
        "visibleElementsMaxAllowableAssociationsSlider": [4, "visible-elements-max-allowable-associations-slider"],
        "visibleElementsStructuralAttachmentAssociationsSettingsArrowsToggle": [4, "visible-elements-structural-attachment-associations-settings-arrows-toggle"],
        "visibleElementsStructuralAttachmentAssociationsSettingsCapSelect": [4, "visible-elements-structural-attachment-associations-settings-cap-select"],
        "visibleElementsStructuralAttachmentAssociationsSettingsStylePicker": [4, "visible-elements-structural-attachment-associations-settings-style-picker"],
        "visibleElementsStructuralAttachmentAssociationsSettingsWidthInput": [4, "visible-elements-structural-attachment-associations-settings-width-input"],
        "position": [1],
        "view": [1040],
        "widget": [1040]
    }, undefined, {
...
function defineCustomElement$1() {
    ...
    const components = ["arcgis-utility-network-associations"];
