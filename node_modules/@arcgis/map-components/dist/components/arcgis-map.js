...
this.constructor.__registerControllers = ()=>__cmpMeta[2]??{};
        ...
        this.view = this.manager.readonly(useMapView(this, { editConstructorProperties: this._editViewProperties }));
    ...
    render() {
        return h("div", { key: '97efc66cc36badcb3451aab1621fed3187510e74', class: "arcgis-map", ref: this._setChildElement });
    }
    ...
    get el() { return this; }
    static get style() { return ArcgisMapStyle0; }
}, __cmpMeta);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["arcgis-map"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-map":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcgisMap$1);
            }
            break;
    } });
}
...
const ArcgisMap = ArcgisMap$1;
const defineCustomElement = defineCustomElement$1;

export { ArcgisMap, defineCustomElement };
