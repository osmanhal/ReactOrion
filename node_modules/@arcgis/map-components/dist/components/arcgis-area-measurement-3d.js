...
import { j as newWidgetsAreaMeasurement3D } from './index2.js';
...
const useAreaMeasurement3dWidget = makeWidgetController(newWidgetsAreaMeasurement3D);
const __cmpMeta = [0,"arcgis-area-measurement-3d",{"autoDestroyDisabled":[1028,"auto-destroy-disabled"],"referenceElement":[1025,"reference-element"],"analysis":[1040],"icon":[1025],"label":[1025],"unit":[1025],"unitOptions":[1040],"position":[1025],"state":[1537],"clear":[64],"destroy":[64],"start":[64]}];
const ArcgisAreaMeasurement3d$1 = /*@__PURE__*/ proxyCustomElement(class ArcgisAreaMeasurement3d extends HTMLElement {
...
this.constructor.__registerControllers = ()=>__cmpMeta[2]??{};
    ...
    get el() { return this; }
    static get style() { return ArcgisAreaMeasurement3dStyle0; }
}, __cmpMeta);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["arcgis-area-measurement-3d"];
