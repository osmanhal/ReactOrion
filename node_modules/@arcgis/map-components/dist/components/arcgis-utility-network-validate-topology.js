...
import { ae as newWidgetsUtilityNetworkValidateTopology } from './index2.js';
...
const ArcgisUtilityNetworkValidateTopology$1 = /*@__PURE__*/ proxyCustomElement(class ArcgisUtilityNetworkValidateTopology extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    render() {
        return h("div", { key: 'b799fc1c383c67bd8690ce4b0df49625493d1b1e', ref: (el) => (this.el.childElem = el) });
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
    ...
    static get style() { return ArcgisUtilityNetworkValidateTopologyStyle0; }
...
function defineCustomElement$1() {
    ...
    const components = ["arcgis-utility-network-validate-topology"];
