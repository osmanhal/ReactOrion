...
import { G as newLayersFeatureLayer, H as newWidgetsFeatureTable } from './index2.js';
...
this.constructor.__registerControllers = ()=>__cmpMeta[2]??{};
        ...
        this.url = this.manager.getSet(undefined, {
            set: (value) => {
                if (value) {
