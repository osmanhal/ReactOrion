...
function awaitReady(element, callback, eventName = "arcgisReady") {
    ...
    if (typeof maybeHasView.view?.ready === "boolean") {
        ...
        element.addEventListener(eventName, () => awaitReady(element, callback, eventName), { once: true });
    }
}
...
export { attachToParent as a, isNotSameViewpoint as b, isNotSameCamera as c, defineViewProperty as d, isNotSameEnvironment as e, addHandles as f, isNullOrEmptyString as i, parseCenter as p, referenceElementHelper as r };
