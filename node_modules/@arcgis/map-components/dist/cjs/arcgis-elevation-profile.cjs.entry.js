...
const useElevationProfileWidget = useWidget.makeWidgetController(index$2.newWidgetsElevationProfile);
const ArcgisElevationProfile = class {
    constructor(hostRef) {
        ...
        this.arcgisPropertyChange = chunkPVEVZB4O.usePropertyChange()("input", "effectiveUnits", "progress", "state");
