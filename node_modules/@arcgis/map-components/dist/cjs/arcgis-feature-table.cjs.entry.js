...
const useFeatureTableWidget = useWidget.makeWidgetController(index$2.newWidgetsFeatureTable);
const ArcgisFeatureTable = class {
    constructor(hostRef) {
        ...
        this.url = this.manager.getSet(undefined, {
            set: (value) => {
                if (value) {
                    index$2.newLayersFeatureLayer({ url: value })
                        .then((layer) => {
                        this.layer = layer;
                    })
                        .catch(console.error);
