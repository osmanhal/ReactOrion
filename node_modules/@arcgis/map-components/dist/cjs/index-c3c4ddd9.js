...
async function importWidgetsBasemapToggle() {
  ...
  const module = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@arcgis/core/widgets/BasemapToggle.js')); });
  return isDefaultModule(module) ? module.default : module;
}
...
async function importWidgetsCompass() {
  ...
  const module = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@arcgis/core/widgets/Compass.js')); });
  return isDefaultModule(module) ? module.default : module;
}
...
async function importWidgetsFullscreen() {
  ...
  const module = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@arcgis/core/widgets/Fullscreen.js')); });
  return isDefaultModule(module) ? module.default : module;
}
...
async function importWidgetsLocate() {
  ...
  const module = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@arcgis/core/widgets/Locate.js')); });
  return isDefaultModule(module) ? module.default : module;
}
...
async function importWidgetsScaleBar() {
  ...
  const module = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@arcgis/core/widgets/ScaleBar.js')); });
  return isDefaultModule(module) ? module.default : module;
}
...
async function importWidgetsTrack() {
  ...
  const module = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@arcgis/core/widgets/Track.js')); });
  return isDefaultModule(module) ? module.default : module;
}
...
async function importWidgetsZoom() {
  ...
  const module = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@arcgis/core/widgets/Zoom.js')); });
  return isDefaultModule(module) ? module.default : module;
}
...
exports.newWidgetsCompass = newWidgetsCompass;
...
exports.newWidgetsFullscreen = newWidgetsFullscreen;
...
exports.newWidgetsLocate = newWidgetsLocate;
...
exports.newWidgetsScaleBar = newWidgetsScaleBar;
...
exports.newWidgetsTrack = newWidgetsTrack;
...
exports.newWidgetsZoom = newWidgetsZoom;
