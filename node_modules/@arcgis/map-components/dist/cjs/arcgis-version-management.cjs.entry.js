...
const useT9n = require('./useT9n-8efcc985.js');
...
const useVersionManagementViewModel = useT9n.makeViewModelController(index$2.newWidgetsVersionManagementVersionManagementViewModel);
const ArcgisVersionManagement = class {
    constructor(hostRef) {
        ...
        this.messages = this.manager.readonly(useT9n.useT9n({ blocking: true }));
    ...
    render() {
        ...
        return (index.h("calcite-flow", { ref: (node) => {
            ...
            }, class: this.mode === "dialog" ? "" : "calcite-flow-widget" }, index.h("calcite-flow-item", { closable: this.closable, heading: label, onCalciteFlowItemClose: () => {
                this._handleFlowItemClose();
