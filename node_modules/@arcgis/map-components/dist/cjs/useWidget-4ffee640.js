...
class WidgetController extends index.AccessorController {
    ...
    _options) {
        ...
        Object.defineProperty(this.exports, "viewModel", {
            value: index.accessorSupport.makeGetterProxy(component, this._watchedViewModelProperties, this._isBindingViewModel),
        });
    ...
    async hostLoad() {
        ...
        index.accessorSupport.reEmitAccessorEvents(this, this._instance, this.reactiveUtils, "widget");
        ...
        if (typeof viewModel === "object") {
            index.accessorSupport.reEmitAccessorEvents(this, viewModel, this.reactiveUtils, "viewModel");
            index.accessorSupport.watchComponentUpdates(this, viewModel, this._watchedViewModelProperties);
            index.accessorSupport.watchAccessorUpdates(this, viewModel, this._watchedViewModelProperties);
        }
...
const proxy = index.proxyExports(WidgetController);

exports.makeWidgetController = makeWidgetController;
