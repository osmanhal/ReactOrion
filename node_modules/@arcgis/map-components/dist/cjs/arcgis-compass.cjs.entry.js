...
const compassCss = "";
const ArcgisCompassStyle0 = compassCss;

const useCompassWidget = useWidget.makeWidgetController(index$2.newWidgetsCompass);
const ArcgisCompass = class {
    constructor(hostRef) {
        ...
        this.arcgisPropertyChange = chunkPVEVZB4O.usePropertyChange()("orientation", "state");
