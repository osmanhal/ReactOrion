...
const useEditorWidget = useWidget.makeWidgetController(index$2.newWidgetsEditor);
const ArcgisEditor = class {
    constructor(hostRef) {
        ...
        this.arcgisPropertyChange = chunkPVEVZB4O.usePropertyChange()("activeWorkflow", "state");
...
exports.arcgis_editor = ArcgisEditor;
