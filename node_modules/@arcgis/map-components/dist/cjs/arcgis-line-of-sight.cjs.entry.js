...
const useLineOfSightWidget = useWidget.makeWidgetController(index$2.newWidgetsLineOfSight);
const ArcgisLineOfSight = class {
    constructor(hostRef) {
...
exports.arcgis_line_of_sight = ArcgisLineOfSight;
