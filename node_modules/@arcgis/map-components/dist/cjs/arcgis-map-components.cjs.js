...
const appGlobals = require('./app-globals-36803398.js');

/*
 Stencil Client Patch Browser v4.17.1 | MIT Licensed | https://stenciljs.com
 */
var patchBrowser = () => {
  const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('arcgis-map-components.cjs.js', document.baseURI).href));
  const opts = {};
  if (importMeta !== "") {
