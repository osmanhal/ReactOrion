...
const ArcgisVersionManagementServiceItem = class {
    ...
    render() {
        ...
        const comboboxVersions = (index.h("calcite-combobox", { key: 'e80f4924dbd00f2a29140b91ee53369dff826d39', clearDisabled: true, label: serviceName, maxItems: 5, overlayPositioning: "fixed", selectionMode: "single-persist", onCalciteComboboxChange: (event) => {
        ...
        if (allowEditing) {
            actionManageVersions = (index.h("calcite-action", { key: 'fc6779c583aa81cf1f12584bda094b7d0d25dd06', id: `actionManageVersions_${serviceName}`, icon: "list", scale: "s", slot: "control", text: "", onClick: async () => {
            ...
            tooltipManageVersions = (index.h("calcite-tooltip", { key: '5d9377d1bec63e4c3d310a3941c0ad693e81f48b', overlayPositioning: "fixed", referenceElement: `actionManageVersions_${serviceName}` }, index.h("span", { key: 'ce2e9fc08127e075738fb2cc59fa5387343eda50' }, strings.headers.manageVersions)));
        }
        return (index.h("calcite-block", { key: '357a2c3e708f61505efa5e1a8f82a7c8ab4ac8dd', open: true, heading: serviceName }, comboboxVersions, actionManageVersions, tooltipManageVersions));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
...
const ArcgisVersionManagementVersionProperties = class {
    ...
    render() {
        ...
        const buttons = (index.h("div", { key: '135d4141e995bbf31123c16d900a1e274575aafb' }, index.h("calcite-button", { key: '44a78143d595fe108d1d312da6ba1bf340be77b8', appearance: "outline", slot: "footer", width: "half", onClick: this._handleCancel }, strings.actions.cancelSave), index.h("calcite-button", { key: '30b32b985a16d7841a444e638309b914cac1b406', slot: "footer", width: "half", onClick: this._handleSave }, strings.actions.saveVersion)));
        const chipGroupAccessLevel = (index.h("calcite-label", { key: 'fb496917361a78043ca219cdb438f30414dd5acd' }, strings.input.versionAccess, index.h("calcite-chip-group", { key: 'f81920bbcdc1bd18187b8107d039cd2a61b8e4dc', label: "access", onCalciteChipGroupSelect: this._handleChange, selectionMode: "single-persist" }, index.h("calcite-chip", { key: '9e55255b9114d1d239a17248ccd200fd097af5f2', selected: (mode === "edit" && versionInfo.access === "public") || mode === "create", value: "public" }, strings.accessLevels.public), index.h("calcite-chip", { key: '03374352be5cfff98f80bb915fe75be762078258', selected: mode === "edit" && versionInfo.access === "protected", value: "protected" }, strings.accessLevels.protected), index.h("calcite-chip", { key: '452499aeb04c69b51101b774d91c0479753cf43b', selected: mode === "edit" && versionInfo.access === "private", value: "private" }, strings.accessLevels.private))));
        const inputDescription = (index.h("calcite-label", { key: '11c04b89dfd8d85b68d322d552ece3bf5cc35567' }, strings.input.versionDescription, index.h("calcite-text-area", { key: '469568f5e6f902076338f1e7a99332d724ff54da', name: "description", onCalciteTextAreaInput: this._handleChange, resize: "vertical", value: mode === "edit" ? versionInfo.description : "" })));
        const inputName = (index.h("calcite-label", { key: '14b2dabc65093f576b8ebca98cec745210353c0b' }, strings.input.versionName, index.h("calcite-input-text", { key: '04c0d47377ea59031fa88c38b996203b0d7c9175', ref: (node) => {
        ...
        const inputOwner = (index.h("calcite-label", { key: 'b1773ab9fd4183852b522f465a6ba5347934c358' }, strings.input.versionOwner, index.h("calcite-input-text", { key: 'e62366ef2e7c143e9f63be1ae177a6b1a3639bce', name: "ownerName", onCalciteInputTextInput: this._handleChange, disabled: !hasAdvEditingUte, value: mode === "edit" ? ownerName : currentUser.toUpperCase() })));
        ...
        return (index.h("calcite-flow-item", { key: '79059091093b6a5c977b43c2530db56f86c98133', closable: closable, description: versionInfo ? versionInfo.versionIdentifier.name : "", heading: versionInfo ? strings.actions.editVersion : strings.actions.newVersion, onCalciteFlowItemClose: this._handleClose }, index.h("calcite-panel", { key: '0eecfe1d97445089ef205e3c4dc569a23edc863c', loading: state === "executing" }, index.h("calcite-block", { key: 'ae61afab2e9d622c41d4b2e0f833057ceba024e0', heading: "", open: true }, inputName, inputDescription, chipGroupAccessLevel, inputOwner, switchToVersionCheckbox, buttons))));
    }
    get el() { return index.getElement(this); }
};
