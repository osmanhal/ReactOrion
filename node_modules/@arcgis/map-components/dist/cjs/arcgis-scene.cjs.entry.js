...
const useWebScene = index$1.makeAccessorController(index$2.newWebScene);
const useSceneView = index$1.makeAccessorController(index$2.newViewsSceneView);
const ArcgisScene = class {
    constructor(hostRef) {
        ...
        this.reactiveUtils = chunkPVEVZB4O.load(index$2.importCoreReactiveUtils);
        /*
        ...
        this.camera = this.manager.getSet(undefined, {
            ...
            set: (newValue, oldValue) => (componentUtils.isNotSameCamera(oldValue, newValue) ? newValue : oldValue),
        });
        ...
        this.environment = this.manager.getSet(this.view.environment, {
            set: (newValue, oldValue) => (componentUtils.isNotSameEnvironment(oldValue, newValue) ? newValue : oldValue),
        });
    ...
    render() {
        return index.h("div", { key: '6ba77135d59e49e02877423619ed7dad7cd01d19', class: "arcgis-scene", ref: this._setChildElement });
    }
