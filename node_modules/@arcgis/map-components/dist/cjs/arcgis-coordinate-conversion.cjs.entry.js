...
const useCoordinateConversionWidget = useWidget.makeWidgetController(index$2.newWidgetsCoordinateConversion);
const ArcgisCoordinateConversion = class {
    constructor(hostRef) {
        ...
        this.arcgisPropertyChange = chunkPVEVZB4O.usePropertyChange()("currentLocation", "state");
