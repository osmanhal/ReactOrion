...
var transformer = {
  ...
  process(sourceText, sourcePath, ...rest) {
    ...
    const removeMutable = sourcePath.endsWith("@stencil/core/internal/testing/index.js");
    return {
      ...result,
      code: shouldTransformControllers ? transformControllers(result.code) : removeMutable ? removeMutationWarning(result.code) : result.code
    };
  }
};
...
var removeMutationWarning = (code) => code.replace(
  `consoleDevWarn(\`@Prop() "\${e}" on <\${t.$tagName$}> is immutable but was modified from within the component.\\nMore information: https://stenciljs.com/docs/properties#prop-mutability\`)`,
  "void 0"
);
export {
